...
"Z"==a?window.location.href="/labs/multi-cmp":-1!=["matrix","cube","discovery"].indexOf(wmgui.visavis_curtype)&&(a=wmgui.vis_endpoint+"/"+wmgui.visavis_curtype+"?q="+a,document.getElementById("visavis_iframe").contentWindow.cmp_download(a,wmgui.visavis_curtype)))}));$("li.discovery_custom").click((function(){if(!document.getElementById("visavis_iframe")||!document.getElementById("visavis_iframe").contentWindow)return!1;var a=document.getElementById("visavis_iframe").contentWindow.visavis.elementals_on,
b="",c="",d;for(d in wmgui.elemental_names)-1!==a.indexOf(d)?b+='<div class="rearrange" rel="'+d+'">'+wmgui.elemental_names[d]+" (&minus;)</div>":c+='<div class="rearrange" rel="'+d+'">'+wmgui.elemental_names[d]+" (+)</div>";c&&$("#discovery_disabled").html(c);$("#discovery_enabled").html(b);$("#discovery_custom_box, #overlay").show()}));$("#discovery_custom_box").on("click","div.rearrange",(function(){var a=$(this),b=a.attr("rel"),c=document.getElementById("visavis_iframe").contentWindow.visavis.elementals_on.indexOf(b);
if("discovery_enabled"==a.parent().attr("id")){if(1==$("#discovery_enabled div.rearrange").length)return!1;-1!==c&&document.getElementById("visavis_iframe").contentWindow.visavis.elementals_on.splice(c,1);$("#discovery_disabled").append('<div class="rearrange" rel="'+b+'">'+wmgui.elemental_names[b]+" (+)</div>");$("#dc_"+b).hide()}else-1==c&&document.getElementById("visavis_iframe").contentWindow.visavis.elementals_on.push(b),$("#discovery_enabled").append('<div class="rearrange" rel="'+b+'">'+wmgui.elemental_names[b]+
" (&minus;)</div>"),$("#dc_"+b).show();a.remove()}));$("#ss_gear_matrix, #ss_gear_cube").click((function(){var a=$(this).attr("id").substr(8);"matrix"==a?($("#ss_z, #sops_z").hide(),$("#ss_x, #ss_y, #sops_x, #sops_y").css("width","50%")):($("#ss_x, #ss_y, #ss_z, #sops_x, #sops_y, #sops_z").css("width","33%"),$("#ss_z, #sops_z").show());var b=$("#ctxpanel_"+a+" > ul > li.embodied").attr("id").split("_")[1],c=$("#ctxpanel_"+a+" > ul > li.ss_y"),d=$("#ctxpanel_"+a+" > ul > li.ss_z"),f=c.length?c.attr("id").split("_")[1]:
