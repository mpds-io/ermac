...
wmgui.v_sd_addr=wmgui.static_host+"/visavis/?280420#"+wmgui.api_host+"/download/p?fmt=json&q=";wmgui.v_ab_vis_addr=wmgui.static_host+"/labs/view-phonons/#"+wmgui.api_host+"/download/p?fmt=json&q=";wmgui.client_data_addr=wmgui.static_host+"/wmdata.json?040521";wmgui.aetmap_addr=wmgui.static_host+"/aets.jpg";wmgui.ermac_root=document.currentScript.src.replace(wmgui.gui_host+"/","").replace("src_js/","").split("/");
wmgui.ermac_root=wmgui.gui_host+"/"+wmgui.ermac_root.slice(0,wmgui.ermac_root.length-1).join("/");wmgui.elemental_names={num:"atomic number",nump:"periodic number",size:"atomic size",rea:"atomic reactivity",rpp:"pseudopotential radii",rion:"ionic radii",rcov:"covalent radii",rmet:"metallic radii",tmelt:"melting temperature",eneg:"electronegativity"};
...
wmgui.editions={0:{name:"Materials Platform for Data Science",prod_url:"https://mpds.io",dev_url:"http://localhost:8070",css:wmgui.ermac_root+"/editions/wm/style.css?270521",actions:function(){$("#logo_l").text("MPDS");$(".only_asm").hide();$(".only_mpds").css("display","inline-block")}},1:{name:"ASM International Materials Platform",prod_url:"https://asm.mpds.io",dev_url:"http://localhost:8075",css:wmgui.ermac_root+"/editions/asm/style.css?270521",actions:function(){$(".only_mpds").hide();$(".only_asm").css("display",
"inline-block");var a=document.querySelector("link[rel*='icon']")||document.createElement("link");a.type="image/x-icon";a.rel="shortcut icon";a.href=wmgui.ermac_root+"/editions/asm/asm.ico";document.getElementsByTagName("head")[0].appendChild(a)}}};
...
$("#ctx_col, #sim_col").hide();wmgui.passive_sim_col=!0;close_vibox()}));$("#hy_box").on("click","span",(function(){var a=$(this).attr("class");$("span."+a).each((function(){var a=$(this);a.parent().find("ul").toggle();"expand"==a.text()?a.text("collapse"):a.text("expand")}))}));$("#hy_box").on("click","a.dynprop",(function(){if(1==wmgui.view_mode)return!0;var a=$(this).attr("data-val");window.location.hash=wmgui.aug_search_cmd("props",a);return!1}));$("#hy_box").on("click","strong.numeric",(function(){var a=
$(this).attr("rel"),b=wmgui.numerics[a],c=b[0],d=b[1],e=b[2],f=b[3];b=b[4];var g=$("div.slider_numerics").length;2<=g&&wmgui.notify("Too little phases have all these properties reported &mdash; expect no results");8<=g||create_floating_slider(a,c,d,e,f,b)}));$("strong.numeric").click((function(){var a=$(this).attr("rel"),b=wmgui.numerics[a];create_floating_slider(a,b[0],b[1],b[2],b[3],b[4])}));$("#hy_options > li").click((function(){var a=$(this),b=a.attr("rev");"hy_vis"==b?window.open(wmgui.static_host+
"/labs/ontology"):(a.addClass("working").siblings().removeClass("working"),$("div.hy_tabs").hide(),$("#"+b).show())}));$("#dtypes > ul > li").click((function(){var a=$(this),b=a.data("facet");a=a.data("term");"classes"==b&&wmgui.search.classes&&(wmgui.search.classes=wmgui.search.classes.replace("peer-reviewed","").replace("peer-review","").replace("machine-learning","").replace("machine learning","").replace("ab initio calculations","").split(",").map((function(a){return a.trim()})).filter((function(a){return a})).join(", "));
window.location.hash=wmgui.aug_search_cmd(b,a)}));$(window).scroll(wmgui.debounce((function(){if(2==wmgui.view_mode&&wmgui.unfinished_page&&50>$("#footer").offset().top-$(window).scrollTop()-$(window).height()){if(!wmgui.unfinished_page)return;wmgui.unfinished_page=!1;var a={offset:wmgui.quick_page_size};$.extend(a,wmgui.search);wmgui.active_ajax=$.ajax({type:"GET",url:wmgui.srch_endpoint,data:{q:JSON.stringify(a),sid:wmgui.sid},beforeSend:wmgui.show_preloader}).always(wmgui.hide_preloader).done((function(a){if(a.error)return wmgui.notify(a.error);
$("div.context_msg").hide();show_hints();a.out.length&&(wmgui.thumbed_display?$("#databrowser tr td").append(build_thumbs(a.out)):($("#databrowser tbody").append(build_cells(a.out)),$("#databrowser").trigger("update")))})).fail((function(a,c,d){"abort"!=c&&wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>")}))}a=$("#iframe");a.length&&!wmgui.is_inview(a)&&close_vibox()}),300));$("#userbox").click((function(){var a=$(this);window.location.hash==a.data("saved_hash")&&
...
else return wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')})).fail((function(a,b,e){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))):"usr_tab_perms"==b?($("#hintsbox_msg").html(WMCORE.get_random_term(wmgui.welcome_msgs)),wmgui.active_ajax=$.ajax({type:"POST",url:wmgui.perms_endpoint,data:{sid:wmgui.sid},beforeSend:wmgui.show_preloader}).always(wmgui.hide_preloader).done((function(a){if(a.error)return wmgui.notify(a.error);
if(!a.hasOwnProperty("gui")||!a.hasOwnProperty("api"))return wmgui.notify('Login error: please, <span class="href relogin">re-login</span>');$("#perms_view").html(describe_perms(a))})).fail((function(a,b,e){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))):"usr_tab_ctrl"==b?window.location.href=wmgui.static_host+(0===wmgui.edition?"/ctrl":"/labs/custom-datasets")+"?"+Math.floor(1E3*Math.random()):"usr_tab_account"==b&&$("#hintsbox_msg").html(WMCORE.get_random_term(wmgui.welcome_msgs))}));
$("#advstab_options > li").click((function(){var a=$(this),b=a.attr("rev");a.addClass("working").siblings().removeClass("working");$("div.advstab").hide();$("#"+b).show()}));$("a.link_adjuster").click((function(){return"#polyhedra"==window.location.hash?(window.location.hash="#polyhedra/",!1):"#polyhedra/"==window.location.hash?(window.location.hash="#polyhedra",!1):!0}));$("#create_usr_api_key").click((function(){$(this).parent().hide();try{wmgui.active_ajax.abort()}catch(a){}wmgui.active_ajax=$.ajax({type:"POST",
url:wmgui.api_key_endpoint,data:{sid:wmgui.sid,create:!0},beforeSend:wmgui.show_preloader}).always(wmgui.hide_preloader).done((function(a){if(a.error)return wmgui.notify(a.error);$("#usr_api_key").html(a.msg);$("#revoke_usr_api_key_holder").show()})).fail((function(a,b,c){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))}));$("#revoke_usr_api_key").click((function(){$(this).parent().hide();try{wmgui.active_ajax.abort()}catch(a){}wmgui.active_ajax=$.ajax({type:"POST",
url:wmgui.api_key_endpoint,data:{sid:wmgui.sid,revoke:!0},beforeSend:wmgui.show_preloader}).always(wmgui.hide_preloader).done((function(a){if(a.error)return wmgui.notify(a.error);$("#usr_api_key").html("Successfully revoked");$("#create_usr_api_key_holder").show()})).fail((function(a,b,c){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))}));$("#login_trigger").click((function(){if(!$(this).data("busy")){$(this).data("busy",!0);$(this).text("In process...");try{wmgui.active_ajax.abort()}catch(a){}wmgui.active_ajax=
$.ajax({type:"POST",url:wmgui.login_endpoint,data:{login:$("#login_email").val().trim(),pass:$("#login_password").val()},beforeSend:wmgui.show_preloader}).always((function(){$("#login_trigger").data("busy",!1);$("#login_trigger").text("Login");wmgui.hide_preloader()})).done((function(a){if(a.error)return wmgui.notify(a.error);if(!a.sid||!a.name||!a.acclogin)return wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>");user_login(a.sid,a.name,a.acclogin,
a.admin);$("#userbox").trigger("click")})).fail((function(a,b,c){wmgui.notify("Login unsuccessful")}))}}));$("#restore_trigger").click((function(){if(!$(this).data("busy")){$(this).data("busy",!0);$(this).text("Sending...");try{wmgui.active_ajax.abort()}catch(a){}wmgui.active_ajax=$.ajax({type:"POST",url:wmgui.restore_endpoint,data:{login:$("#restore_by_email").val().trim(),ed:wmgui.edition},beforeSend:wmgui.show_preloader}).always((function(){$("#restore_trigger").data("busy",!1);$("#restore_trigger").text("Send link");
wmgui.hide_preloader()})).done((function(a){if(a.error)return wmgui.notify(a.error);wmgui.notify("Please, check your inbox (and spam)");$("#userbox").trigger("click")})).fail((function(a,b,c){"abort"!=b&&wmgui.notify("A network error occured. Please, try again")}))}}));$("#account_holder_accpass > span").click((function(){$("#account_pass_change").toggle()}));$("#password_trigger").click((function(){var a=$("#new_password_1").val(),b=$("#new_password_2").val();if(!a||!b)return wmgui.notify("Please, type your new password in both fields");
if(a!==b)return wmgui.notify("Passwords do not match (typo?)");if(!$(this).data("busy")){$(this).data("busy",!0);$(this).text("Changing...");try{wmgui.active_ajax.abort()}catch(c){}wmgui.active_ajax=$.ajax({type:"POST",url:wmgui.password_endpoint,data:{new_password:b,sid:wmgui.sid},beforeSend:wmgui.show_preloader}).always((function(){$("#password_trigger").data("busy",!1);$("#password_trigger").text("Change");wmgui.hide_preloader()})).done((function(a){if(a.error)return wmgui.notify(a.error);user_login(a.sid,
a.name,a.acclogin,a.admin);window.location.replace("#start");$("#account_pass_change").hide()})).fail((function(a,b,e){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))}}));$("#logout_trigger").click((function(){$.ajax({type:"POST",url:wmgui.logout_endpoint,data:{sid:wmgui.sid}}).done((function(a){})).fail((function(a,b,c){}));user_logout();$("#userbox").trigger("click")}));$("#notifybox").on("click","span.relogin",force_relogin);$("#search_holder").keydown((function(a){13==
(window.event?a.keyCode:a.which)&&$("#search_trigger").trigger("click")}));$("#control_a").click((function(){re_view_request(0)}));$("#control_b").click((function(){re_view_request(1)}));$("#control_f").click((function(){re_view_request(2)}));$("#control_c").click((function(){wmgui.visavis_terminating=!0;wmgui.thumbed_display=!1;if(wmgui.visavis_working){var a={},b;for(b in wmgui.search)-1<["search_type","phid","numeric"].indexOf(b)||(a[b]=wmgui.search[b]);a=$.param(a);window.location.hash=="#inquiry/"+a&&
(a="="==a.slice(-1)?a.substr(0,a.length-1):a+"=");window.location.hash="#inquiry/"+a}else re_view_request(wmgui.search_type);wmgui.chosen_table_browser=!0}));$("#control_d").click((function(){wmgui.visavis_terminating=!0;wmgui.thumbed_display=!0;if(wmgui.visavis_working){var a={},b;for(b in wmgui.search)-1<["search_type","phid","numeric"].indexOf(b)||(a[b]=wmgui.search[b]);a=$.param(a);window.location.hash=="#inquiry/"+a&&(a="="==a.slice(-1)?a.substr(0,a.length-1):a+"=");window.location.hash="#inquiry/"+
a}else re_view_request(wmgui.search_type);wmgui.chosen_table_browser=!0}));$("#control_e").click((function(){var a={};for(b in wmgui.search)-1<["search_type","phid","numeric"].indexOf(b)||(a[b]=wmgui.search[b]);for(;;){var b=WMCORE.get_random_term(["matrix","cube"]);if(b!=wmgui.visavis_curtype)break}window.location.hash="#plot/"+b+"/inquiry/"+$.param(a)}));$("#ctxpanel_matrix > ul > li").click((function(){var a=$(this);if(!a.hasClass("embodied")&&!a.hasClass("ss_y")){var b=a.attr("id").split("_")[1],
c=$("#ctxpanel_matrix > ul > li.ss_y");$("#ctxpanel_matrix > ul > li.embodied").removeClass("embodied");c.length&&c.removeClass("ss_y");a.addClass("embodied");$("span.sops").remove();document.getElementById("visavis_iframe").contentWindow.matrix_order(b)}}));$("#ctxpanel_cube > ul > li").click((function(){var a=$(this);if(!(a.hasClass("embodied")||a.hasClass("ss_y")||a.hasClass("ss_z"))){var b=a.attr("id").split("_")[1],c=$("#ctxpanel_cube > ul > li.ss_y"),d=$("#ctxpanel_cube > ul > li.ss_z");$("#ctxpanel_cube > ul > li.embodied").removeClass("embodied");
c.length&&c.removeClass("ss_y");d.length&&d.removeClass("ss_z");a.addClass("embodied");$("span.sops").remove();-1!==document.getElementById("visavis_iframe").contentWindow.location.hash.indexOf("fixel=1")?document.getElementById("visavis_iframe").contentWindow.matrix_order(b):document.getElementById("visavis_iframe").contentWindow.cube_order(b,b,b)}}));$("#ctxpanel_graph > ul > li").click((function(){var a=$(this);if(!a.hasClass("embodied")){var b=a.attr("id").split("_")[1];$("#ctxpanel_graph > ul > li.embodied").removeClass("embodied");
a.addClass("embodied");document.getElementById("visavis_iframe").contentWindow.graph_rebuild(b)}}));$("#select_cmp_trigger").change((function(){var a=$(this).val();$("#select_cmp_trigger option:selected").text();wmgui.dc_ctrl_flag=!0;"X"!=a&&("Y"==a?document.getElementById("visavis_iframe").contentWindow.cmp_discard(wmgui.visavis_curtype):-1!=["matrix","cube","discovery"].indexOf(wmgui.visavis_curtype)&&(a=wmgui.vis_endpoint+"/"+wmgui.visavis_curtype+"?q="+a,document.getElementById("visavis_iframe").contentWindow.cmp_download(a,
wmgui.visavis_curtype)))}));$("li.discovery_custom").click((function(){if(!document.getElementById("visavis_iframe")||!document.getElementById("visavis_iframe").contentWindow)return!1;var a=document.getElementById("visavis_iframe").contentWindow.visavis.elementals_on,b="",c="",d;for(d in wmgui.elemental_names)-1!==a.indexOf(d)?b+='<div class="rearrange" rel="'+d+'">'+wmgui.elemental_names[d]+" (&minus;)</div>":c+='<div class="rearrange" rel="'+d+'">'+wmgui.elemental_names[d]+" (+)</div>";c&&$("#discovery_disabled").html(c);
$("#discovery_enabled").html(b);$("#discovery_custom_box, #overlay").show()}));$("#discovery_custom_box").on("click","div.rearrange",(function(){var a=$(this),b=a.attr("rel"),c=document.getElementById("visavis_iframe").contentWindow.visavis.elementals_on.indexOf(b);if("discovery_enabled"==a.parent().attr("id")){if(1==$("#discovery_enabled div.rearrange").length)return!1;-1!==c&&document.getElementById("visavis_iframe").contentWindow.visavis.elementals_on.splice(c,1);$("#discovery_disabled").append('<div class="rearrange" rel="'+
b+'">'+wmgui.elemental_names[b]+" (+)</div>");$("#dc_"+b).hide()}else-1==c&&document.getElementById("visavis_iframe").contentWindow.visavis.elementals_on.push(b),$("#discovery_enabled").append('<div class="rearrange" rel="'+b+'">'+wmgui.elemental_names[b]+" (&minus;)</div>"),$("#dc_"+b).show();a.remove()}));$("#ss_gear_matrix, #ss_gear_cube").click((function(){var a=$(this).attr("id").substr(8);"matrix"==a?($("#ss_z, #sops_z").hide(),$("#ss_x, #ss_y, #sops_x, #sops_y").css("width","50%")):($("#ss_x, #ss_y, #ss_z, #sops_x, #sops_y, #sops_z").css("width",
"33%"),$("#ss_z, #sops_z").show());var b=$("#ctxpanel_"+a+" > ul > li.embodied").attr("id").split("_")[1],c=$("#ctxpanel_"+a+" > ul > li.ss_y"),d=$("#ctxpanel_"+a+" > ul > li.ss_z"),e=c.length?c.attr("id").split("_")[1]:b,f=d.length?d.attr("id").split("_")[1]:b,g="",k="",h="";$("#ctxpanel_"+a+" > ul > li").each((function(){var c=$(this),d=c.attr("id").split("_")[1];c=c.contents().filter((function(){return 1!==this.nodeType}))[0].data.substr(3);var l=d==b?' class="ss_x"':"";g+='<li rev="ss_x" rel="x_'+
d+'"'+l+">"+c+"</li>";l=d==e?' class="ss_y"':"";k+='<li rev="ss_y" rel="y_'+d+'"'+l+">"+c+"</li>";if("matrix"==a)return!0;l=d==f?' class="ss_z"':"";h+='<li rev="ss_z" rel="z_'+d+'"'+l+">"+c+"</li>"}));$("#ss_x > ul").html(g);$("#ss_y > ul").html(k);"cube"==a&&$("#ss_z > ul").html(h);$("li.sops_x").removeClass("sops_x");$("li.sops_y").removeClass("sops_y");$("li.sops_z").removeClass("sops_z");var m=["x","y","z"];$("span.sops").each((function(){var a=$(this),b=a.text(),c=a.attr("rel");$("#sops_"+c+' > ul > li:contains("'+
b+'")').addClass("sops_"+c);m=m.filter((function(a){return a!==c}))}));m.forEach((function(a){$("#sops_"+a+' > ul > li:contains("none")').addClass("sops_"+a)}));$("#ss_custom_box, #overlay").show()}));$("div.ss_col").on("click","li",(function(){var a=$(this),b=a.attr("rev"),c=a.attr("rel").split("_")[0];c="x"==c?"ss_x":"y"==c?"ss_y":"ss_z";$("#"+b+" > ul > li."+c).removeClass(c);a.addClass(c)}));$("div.sops_col").on("click","li",(function(){var a=$(this),b=a.parent().parent().attr("id"),c=b.split("_")[1];
c="x"==c?"sops_x":"y"==c?"sops_y":"sops_z";$("#"+b+" > ul > li."+c).removeClass(c);a.addClass(c)}));$("#tips_trigger").click((function(){wmgui.tooltip_var=0;show_tooltip(wmgui.tooltips.advsearch);return!1}));$("#numericbox").on("click","div.slider_close",(function(){if(1==$("div.slider_numerics").length)return destroy_numericbox(),delete wmgui.search.numeric,!1;var a=$(this);a.siblings("div.slider").children("div.slider_numerics")[0].noUiSlider.destroy();a.parent("li").fadeOut(250,(function(){$(this).remove()}))}));
$("#numericbox_do_trigger").click((function(){$("#advsbox").is(":visible")?$("#advsearch_do_trigger").trigger("click"):$("#search_trigger").trigger("click")}));$("#numericbox_drop_trigger").click((function(){for(var a=document.getElementsByClassName("slider_numerics"),b=0;b<a.length;b++){var c=a[b].noUiSlider.options.range;a[b].noUiSlider.set([c.min,c.max])}}));$("#close_numericbox").click((function(){destroy_numericbox();delete wmgui.search.numeric}));$(document).keydown((function(a){a=window.event?a.keyCode:
a.which;13==a?(a=$(":focus"),a.hasClass("submitter")?a.parent().parent().find("div.def_submittable").trigger("click"):(a.hasClass("advs_input")||(a.attr("id")||"").startswith("advs_fct_"))&&$("#advsearch_do_trigger").trigger("click")):27==a&&(a=$("div.cross:visible"),a.length&&a.trigger("click"))}));$(window).bind("hashchange",url_redraw_react);$(window).bind("storage",(function(a){if("wm_reload"==a.originalEvent.key&&(a=a.originalEvent.newValue)&&window[a])window[a]()}))};
var wmgui=window.wmgui||{};
...
var wmgui=window.wmgui||{};wmgui.notify=function(a){var b=0;wmgui.notify_counter&&(clearInterval(wmgui.notify_counter),wmgui.notify_counter=null,b=1500);setTimeout((function(){$("#notifybox").html(wmgui.clean(a)).show();wmgui.notify_counter=setTimeout((function(){$("#notifybox").hide()}),5E3)}),b)};
wmgui.aug_search_cmd=function(a,b){for(var d=[["elements","formulae"],["formulae","elements"],["lattices","sgs"],["sgs","lattices"],["protos","sgs"],["sgs","protos"],["lattices","protos"],["protos","lattices"]],c=0;c<d.length;c++)if(wmgui.search[d[c][0]]&&a==d[c][1]){delete wmgui.search[d[c][0]];break}var e=!1;$.each(wmgui.inquiries,(function(c,f){if(wmgui.search[f]||f==a)return e=!0,!1}));if(e){var g={};$.each(wmgui.facets,(function(f,c){wmgui.search[c]&&c==a?-1!==wmgui.multi_facets.indexOf(c)?g[c]=
wmgui.search[c]+","+b:g[c]=b:wmgui.search[c]?g[c]=wmgui.search[c]:c==a&&(g[c]=b)}));return"#inquiry/"+$.param(g)}var f="";$.each(wmgui.facets,(function(c,d){wmgui.search[d]&&d==a?f="classes"==d?f+(wmgui.search[d]+" "+b+" "):f+(b+" "):wmgui.search[d]?f+=wmgui.search[d]+" ":d==a&&(f+=b+" ")}));return"#search/"+f.substr(0,f.length-1)};
wmgui._selectize_read=function(a){var b={},d="#search_holder";"main"!==a&&(d="div.advs_"+a);$(d+" div.selectize-input.items").children().each((function(){if("DIV"==this.tagName){var a=this.getAttribute("data-facet");-1!==wmgui.other_facets.indexOf(a)&&wmgui.search[a]?b[a]=wmgui.search[a]:"numeric"==a?wmgui.search[a]&&(b[a]="",wmgui.search[a].forEach((function(c){b[a]+=serialize_numeric.apply(this,c)})),b[a].length&&(b[a]=b[a].substr(0,b[a].length-1))):b[a]&&"elements"==a?b[a]+="-"+this.getAttribute("data-term"):
...
wmgui._selectize_write=function(a,b,d){var c={};$.extend(c,d);if("main"==b){b="formulae props elements classes lattices aetypes".split(" ");for(d=0;d<wmgui.other_facets.length;d++)c[wmgui.other_facets[d]]&&a.display(wmgui.other_facets[d],wmgui.facet_names[wmgui.other_facets[d]].toLowerCase());c.numeric&&a.display("numeric","range search")}else b=[b];b.forEach((function(b){c[b]&&("elements"==b&&0<c[b].indexOf("-")?c[b].split("-").forEach((function(c){a.display(b,c)})):-1!==wmgui.multi_facets.indexOf(b)&&
0<c[b].indexOf(",")?c[b].split(",").forEach((function(c){a.display(b,c)})):("formulae"==b&&(c[b]=WMCORE.to_formula(c[b])),a.display(b,c[b])))}));a.clearOptions()};wmgui._selectize_display=function(a,b,d){var c=Math.floor(1E3*Math.random());a.addOption({facet:b,label:d,id:c});a.addItem(c)};function show_interpretation(a){$("#interpret").html(wmgui.clean(WMCORE.get_interpretation(a,wmgui.facet_names,wmgui.numerics)))}
function re_view_request(a){var b=[];$.each(wmgui.search,(function(a,c){if("search_type"==a)return!0;b.push(c)}));b.length&&(wmgui.search_type=a,wmgui.search.search_type=a,request_search(wmgui.search,b.join(" "),!0))}
function request_search(a,b,d){if(!manage_visavis(rebuild_history_box,a,b)){try{wmgui.active_ajax.abort()}catch(c){}try{wmgui.quick_ajax.abort()}catch(c){}wmgui.active_ajax=$.ajax({type:"GET",url:wmgui.srch_endpoint,data:{q:JSON.stringify(a),sid:wmgui.sid},beforeSend:wmgui.show_preloader}).always(wmgui.hide_preloader).done((function(c){if(c.error)return wmgui.notify(c.error);b=b.replaceAll("%2F","/");if(!c.out.length)return wmgui.notify("No results for <b>"+b+"</b>");wmgui.fuzzyout=!1;c.fuzzy_notice&&
...
show_hints(a.entry||a.interlinkage)):c.estimated_count>wmgui.quick_page_size+wmgui.fetch_page_size?($("#toomuch span").html("nearly "+(c.estimated_count-wmgui.quick_page_size)).parent().show(),show_hints(a.entry)):c.estimated_count>wmgui.quick_page_size?($("#loadscroll").show(),wmgui.unfinished_page=!0):show_hints(a.entry);wmgui.visavis_terminating&&stop_visavis();wmgui.search_type||a.phid||a.entry||a.interlinkage||a.doi||a.numeric?($("#dtypes").hide(),display_examples("#examples",!0,!0),a.phid||
a.entry||a.interlinkage?switch_control_mode(9,11,"a","c"):a.numeric?(switch_control_mode(1,12,"b",!1),destroy_numericbox(),$.each(get_sliders_ranges(a.numeric,wmgui.numerics),(function(a,b){create_floating_slider.apply(this,b)}))):switch_control_mode(1,10,!1,!1),a.entry&&"S"==a.entry.substr(0,1)&&(c=$("#e__"+a.entry),c.removeClass("busy_entry"),open_context(c,!0))):($("#dtypes").show(),wmgui.fuzzyout?switch_control_mode(1,11,"a",!1):switch_control_mode(0,10,!1,!1),request_refinement(a,c.estimated_count>
wmgui.quick_page_size));a.numeric||destroy_numericbox();a.props&&wmgui.numerics[a.props]&&(c=wmgui.numerics[a.props],create_floating_slider(a.props,c[0],c[1],c[2],c[3],c[4]));d||rebuild_history_box(a,b)})).fail((function(a,b,d){"abort"!=b&&wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>")}))}}
function rebuild_history_box(a,b){var d={};wmgui.facets.forEach((function(b){a[b]&&(d[b]=a[b])}));var c=!1;$.each(wmgui.inquiries,(function(a,b){if(d[b])return c=!0,!1}));var e=[];for(g in d)e.push(d[g].toLowerCase());e.sort();var g=e.join(" ");e=JSON.parse(window.localStorage.getItem("wm_search_log_v4")||"[]");var f=[];8<e.length&&(e=e.slice(0,7));$.each(e,(function(a,b){a=[];for(var c in b)a.push(b[c].toLowerCase());a.sort();f.push(a.join(" "))}));-1==f.indexOf(g)&&(b=c?'<a href="#inquiry/'+$.param(d)+
'">'+b+"</a>":'<a href="#search/'+escape(b)+'">'+b+"</a>",$("#history ul").prepend("<li>"+wmgui.clean(b)+"</li>"),e.unshift(d),window.localStorage.setItem("wm_search_log_v4",JSON.stringify(e)),8<$("#history ul li").length&&$("#history ul li:last").remove());wmgui.tooltip_var++;1==wmgui.tooltip_var&&setTimeout((function(){show_tooltip(wmgui.tooltips.interpretation)}),3E3)}
function rebuild_visavis(){var a=window.location.hash.indexOf("search/");if(-1==a&&(a=window.location.hash.indexOf("inquiry/"),-1==a))return;var b=window.location.hash.substr(a);$("a.pltcol_links").each((function(){var a=$(this),d=a.attr("rev");a.attr("href",wmgui.gui_host+window.location.pathname+"#plot/"+d+"/"+b)}));$("#visavis_col > ul > li").removeClass("embodied");$("#pltchoice_"+wmgui.visavis_curtype).addClass("embodied");-1<["matrix","cube","discovery"].indexOf(wmgui.visavis_curtype)&&update_dc();
if("matrix"==wmgui.visavis_curtype)$("#ctxpanel_matrix > ul > li.embodied").removeClass("embodied"),a=$("#ctxpanel_matrix > ul > li.ss_y"),a.length&&a.removeClass("ss_y"),$("#vismatrix_nump").addClass("embodied"),$("span.sops").remove();else if("cube"==wmgui.visavis_curtype){$("#ctxpanel_cube > ul > li.embodied").removeClass("embodied");a=$("#ctxpanel_cube > ul > li.ss_y");var d=$("#ctxpanel_cube > ul > li.ss_z");a.length&&a.removeClass("ss_y");d.length&&d.removeClass("ss_z");$("#viscube_nump").addClass("embodied");
...
function display_examples(a,b,d){null===wmgui.cliff_counter&&(wmgui.cliff_counter=Math.floor(Math.random()*wmgui.cliffhangers.length));for(var c="",e=0;e<(b?12:3);e++)wmgui.cliff_counter+=1,wmgui.cliff_counter>wmgui.cliffhangers.length-1&&(wmgui.cliff_counter=0),c+='<li><a href="#search/'+WMCORE.termify_formulae(wmgui.cliffhangers[wmgui.cliff_counter])+'">'+wmgui.cliffhangers[wmgui.cliff_counter].charAt(0).toUpperCase()+wmgui.cliffhangers[wmgui.cliff_counter].slice(1)+"</a></li>";$(a+" > ul").empty().append(c);
$(a).show();d&&($("#refine_col > div.col_title, #refine_col > ul").hide(),$("#refine_col").show())}
function arrange_menu_collateral(){$("#hintsbox_msg, #tagcloudbox").empty();for(var a="",b=0;b<wmgui.collateral_links.length;b++){var d=wmgui.collateral_links[b][1],c=wmgui.collateral_links[b][1]?"collateral":!1,e="",g="";b%2&&(c=c?c+" violet":"violet",g="<br />");wmgui.collateral_links[b][3]&&(e=' target="_blank"');a+="<a"+e+' href="'+wmgui.collateral_links[b][0]+'"'+(c?' class="'+c+'"':"")+(d?" rel="+d:"")+">"+wmgui.collateral_links[b][2]+"</a>"+g}$("#tagcloudbox").append(a);$("#hintsbox_msg").append(WMCORE.get_random_term(wmgui.welcome_msgs))}
...
function switch_control_mode(a,b,d,c){0==a?$("#control_c, #control_d, #control_e").css("width","33.3%").show():1==a?($("#control_e").hide(),$("#control_c, #control_d").css("width","50%").show()):9==a?($("#control_e, #control_d").hide(),$("#control_c").css("width","100%").show()):10==a?$("#control_a, #control_b, #control_f").css("width","33.3%").show():11==a?($("#control_b, #control_f").hide(),$("#control_a").css("width","100%").show()):12==a&&($("#control_a, #control_f").hide(),$("#control_b").css("width",
"100%").show());b&&(d||(d={0:"a",1:"b",2:"f"}[wmgui.search_type]),c||(c=wmgui.thumbed_display?"d":"c"),$("div.controlswitch > div").removeClass(),$("#control_"+d+", #control_"+c).addClass("active"),switch_control_mode(b))}
function build_cells(a,b,d){var c={7:" ml_data",8:" ab_data",9:" ab_data",10:" ab_data",11:" ab_data"},e="";b&&(e+=b);if(2==wmgui.search_type){if(6!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";$.each(a,(function(a,b){b[0]=parseInt(b[0]);999999==b[0]&&(b[4]=wmgui.mockyear);e+='<tr id="e__B'+b[0]+'" class="tcell" data-type="B"><td class=c55>[<a class="resolve_ref'+(-1<wmgui.bid_history.indexOf(b[0])?" visited":"")+'" href="'+wmgui.refs_endpoint+
"?ref_id="+b[0]+"&sid="+wmgui.sid+"&ed="+wmgui.edition+'" rel="'+b[0]+'" target="_blank" rel="noopener noreferrer">'+b[0]+"</a>]</td><td class=a1>"+b[1]+'</td><td class=a2 title="'+b[2]+'">'+b[2]+"</td><td class=a5>"+b[5]+"</td><td class=cj>"+b[3]+"</td><td class=c4>"+b[4]+"</td></tr>"}))}else if(1==wmgui.search_type){if(5!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";$.each(a,(function(a,b){e+='<tr id="e__Z'+b[0]+'" class="tcell" data-type="Z"><td class=p1>'+
b[1]+"</td><td class=p2>"+b[2]+"</td><td class=p3>"+b[3]+"</td><td class=p4>"+b[4]+'</td><td class=p5><a class=launch_ph href="#phase_id/'+b[0]+'">Show entries</a></td></tr>'}))}else{if(8!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";$.each(a,(function(a,b){b[7]=parseInt(b[7]);a=b[0].substr(0,1);var d=4==b[3]||5==b[3]||6==b[3]||9==b[3]||10==b[3]?"<span class=launch_v>Show</span>":" ",f=999999==b[7]?"<td class=cj>&mdash;</td><td class=c4>"+
wmgui.mockyear+"</td><td class=c5>&mdash;</td>":"<td class=cj>"+b[5]+"</td><td class=c4>"+b[6]+'</td><td class=c5>[<a class="resolve_ref'+(-1<wmgui.bid_history.indexOf(b[7])?" visited":"")+'" href="'+wmgui.refs_endpoint+"?ref_id="+b[7]+"&sid="+wmgui.sid+"&ed="+wmgui.edition+'" rel="'+b[7]+'" target="_blank" rel="noopener noreferrer">'+b[7]+"</a>]</td>";e+='<tr id="e__'+b[0]+'" class="tcell'+(c[b[3]]||"")+(b[4]?" opened":"")+'" data-type="'+a+'" data-rank="'+b[3]+'" title="Click for more info"><td class=c1>'+
b[1]+"</td><td class=cp>"+d+"</td><td class=c2>"+b[2]+"</td>"+f+"</tr>"}))}d&&(e+=d);return e}
function build_thumbs(a){var b={6:" pd_full",7:" ml_data",8:" ab_data",9:" ab_data",10:" ab_data",11:" ab_data"},d="";if(2==wmgui.search_type){if(6!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";a.sort((function(a,b){return a[4]>b[4]?1:a[4]<b[4]?-1:0}));var c="",e=!!wmgui.sid;$.each(a,(function(a,b){b[0]=parseInt(b[0]);999999==b[0]&&(b[4]=wmgui.mockyear);c=e?(60<b[1].length?b[1].substr(0,60)+"&hellip;":b[1])+", <span>"+(80<b[2].length?
b[2].substr(0,80)+"&hellip;":b[2])+"</span>":"<br /><br />&#x1f4d6;";d+='<div class="gallery_item" id="e__B'+b[0]+'" data-type="B"><div class="gallery_img"><div class="articled">'+c+'</div></div><div class="gallery_label"><i>'+b[5]+'</i><br />[<a class="resolve_ref'+(-1<wmgui.bid_history.indexOf(b[0])?" visited":"")+'" href="'+wmgui.refs_endpoint+"?ref_id="+b[0]+"&sid="+wmgui.sid+"&ed="+wmgui.edition+'" rel="'+b[0]+'" target="_blank" rel="noopener noreferrer">'+b[3]+"&rsquo;"+b[4].toString().substr(2,
2)+"</a>]</div></div>"}))}else if(1==wmgui.search_type){if(5!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";a.sort((function(a,b){return a[1]>b[1]?1:a[1]<b[1]?-1:0}));$.each(a,(function(a,b){d+='<div class="gallery_item" id="e__Z'+b[0]+'" data-type="Z"><div class="gallery_img"><div class="phased">'+b[1]+"<br /><br />SG "+b[2]+'</div></div><div class="gallery_label"><a class=launch_ph href="#phase_id/'+b[0]+'">Show '+b[3]+(1==b[3]?
" entry":" entries")+"</a><br />Publications: "+b[4]+"</div></div>"}))}else{if(8!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";a.sort((function(a,b){var c=a[0].substr(0,1),d=b[0].substr(0,1);if("S"==c)return"S"==d?a[1]>b[1]?1:a[1]<b[1]?-1:0:-1;if("C"==c){if("C"==d)return a[1]>b[1]?1:a[1]<b[1]?-1:0;if("S"==d)return 1;if("P"==d)return-1}if("P"==c)return"P"==d?a[2].toUpperCase()>b[2].toUpperCase()?1:a[2].toUpperCase()<b[2].toUpperCase()?
-1:0:1}));$.each(a,(function(a,c){c[7]=parseInt(c[7]);a=c[0].substr(0,1);var e=999999==c[7]?"<br />&mdash;":'<br />[<a class="resolve_ref'+(-1<wmgui.bid_history.indexOf(c[7])?" visited":"")+'" href="'+wmgui.refs_endpoint+"?ref_id="+c[7]+"&sid="+wmgui.sid+"&ed="+wmgui.edition+'" rel="'+c[7]+'" target="_blank" rel="noopener noreferrer">'+c[5]+"&rsquo;"+c[6].toString().substr(2,2)+"</a>]";if("P"==a)var f="<div>"+c[2]+"</div>";else"S"==a?f='<img alt="'+c[0]+'" src="'+wmgui.static_host+"/rd_thumbs/"+c[0].split("-")[0]+
'.png" />':(c[2]=c[2].split(";")[0],c[2]=c[2].split(" ")[c[2].split(" ").length-1],f='<img alt="'+c[0]+'" src="'+wmgui.static_host+"/pd_thumbs/"+c[0].split("-")[0]+'.png" /><p>'+c[2]+"</p>");d+='<div class="gallery_item'+(b[c[3]]||"")+(c[4]?" opened":"")+'" id="e__'+c[0]+'" data-type="'+a+'" data-rank="'+c[3]+'" title="Click for more info"><div class="gallery_img">'+f+'</div><div class="gallery_label">'+c[1]+e+"</div></div>"}))}return d}
function request_refinement(a,b){$("#examples").hide();$("#refine_col > ul").empty().parent().show();$("#refine_col > div.col_title").show();var d={is_heavy:b};$.extend(d,a);try{wmgui.active_ajax.abort()}catch(c){}wmgui.active_ajax=$.ajax({type:"GET",url:wmgui.rfn_endpoint,data:{q:JSON.stringify(d)},beforeSend:function(){$("#rfn_preloader").show()}}).always((function(){$("#rfn_preloader").hide()})).done((function(c){if(c.error)return wmgui.notify(c.error);var e=null,g="",f=[],l=0;delete d.is_heavy;d.classes&&
(f=d.classes.split(",").map((function(a){return a.trim()})),d.classes=f.join(","));var m=!1;$.each(wmgui.inquiries,(function(a,b){if(d[b])return m=!0,!1}));$.each(c.payload,(function(c,h){if(a.formulae&&"elements"==h.facet)return!0;var n="",p=!1,k={};$.each(d,(function(a,b){if(-1<["search_type","phid","numeric"].indexOf(a)||"elements"==h.facet&&("elements"==a||"formulae"==a)||"props"==h.facet&&"props"==a)return!0;n+=b+" ";k[a]=k[a]?k[a]+(", "+b):b}));a.classes&&"classes"==h.facet&&$.each(f,(function(a,b){if(b==
h.value)return p=!0,!1}));if(p)return!0;h.facet!=e&&(e&&b&&(g+='<li class="fct_'+e+' extd_refine"><a class="extd_refine" rel="'+e+'" href="#">Show more&nbsp;</a></li>'),g+='<li class="new_rfn_facet fct_'+h.facet+'">'+wmgui.facet_names[h.facet]+"</li>",e=h.facet);"props"==h.facet&&(h.value=h.value.replace(/\(|\)/g,"").replace(/\/[\w\-]*/g,""));k[h.facet]=k[h.facet]?k[h.facet]+(", "+h.value):h.value;k.elements&&(k.elements=k.elements.replaceAll(", ","-"));g=m?g+('<li class="fct_'+h.facet+'"><a href="#inquiry/'+
$.param(k)+'">'+h.value+"</a></li>"):g+('<li class="fct_'+h.facet+'"><a href="#search/'+n+h.value+'">'+h.value+"</a></li>");l++}));b&&(g+='<li class="fct_'+e+' extd_refine"><a class="extd_refine" rel="'+e+'" href="#">Show more&nbsp;</a></li>');0==l?display_examples("#examples",!0,!0):($("#refine_col > ul").show().append(wmgui.clean(g)),10>=l&&display_examples("#examples",!1,!1))})).fail((function(a,b,d){"abort"!=b&&(429==a.status?wmgui.notify("Request rate limiting policy: please retry in a few seconds"):
wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>"))}))}
function open_context(a,b){close_vibox();if(a.hasClass("busy_entry")){a.removeClass("busy_entry");$("#ctx_col, #sim_col").hide();try{wmgui.quick_ajax.abort()}catch(f){}}else{var d=a.attr("id").substr(3),c=parseInt(a.attr("data-rank")),e=d.substr(0,1),g=d.split("-")[0];$(".busy_entry").removeClass("busy_entry");a.addClass("busy_entry");"Z"!=e&&"B"!=e&&($("#entryno").html('<a href="#entry/'+g+'">'+g+"</a>"),$("#ctx_col").show(),$("#visualize, div.spinoff_pane, li.d_icon").hide(),open_sim_col(d,e,c),
...
$(this).attr("rel"),b="S"==e?"&export=1":"",c="raw"==a?"null":wmgui.sid;a=wmgui.dd_addr_tpl+"/"+e.toLowerCase()+"?q="+d+"&fmt="+a+"&sid="+c+b+"&ed="+wmgui.edition;$(this).attr("href",a)})),b&&launch_iframed_app(c))}}
function open_sim_col(a,b,d){$("#sim_col > ul, #sim_legend").empty();$(".sim_col_ctx").hide();$("#sim_col").show();var c={q:a},e=-1<[0,1,4,9].indexOf(d);e&&(c.allpurpose=!0);try{wmgui.quick_ajax.abort()}catch(g){}wmgui.quick_ajax=$.ajax({type:"GET",url:wmgui.sim_endpoint,data:c,beforeSend:function(){$("#sim_preloader").show()}}).always((function(){$("#sim_preloader").hide()})).done((function(c){if(c.error)return wmgui.notify(c.error);var f=0,g="";if(e)$.each(c.out.sim,(function(a,b){if(7==f)return!1;
g=b[4]?g+('<li><a href="#inquiry/'+$.param({elements:b[1],years:b[2],codens:b[3],classes:1==b[4]?"":b[4]})+'">'+b[0]+"</a></li>"):g+('<li><a href="#inquiry/'+$.param({formulae:b[1],years:b[2],codens:b[3]})+'">'+b[0]+"</a></li>");f++}));else if("C"==b||"S"==b)3<d&&($.each(c.out.sim,(function(a,b){if(8==f)return!1;g+='<li><a href="#phase_id/'+b[1]+'">'+b[0]+"</a></li>";f++})),"C"==b&&$("#pd_legend").show());else{var m=wmgui.thumbed_display?$("div.busy_entry > div.gallery_img > div").text().split(";")[0]:
$("tr.busy_entry > td.c2").text().split(";")[0];$.each(c.out.sim,(function(a,b){if(8==f)return!1;g+='<li><a href="#search/'+m+" "+b[1]+'">'+b[0]+"</a></li>";f++}))}f?(e?$("#sim_legend").removeClass("apparent").text("Also studied by these authors:"):"C"==b?$("#sim_legend").removeClass("apparent").text("Phases at the diagram:"):"S"==b?$("#sim_legend").removeClass("apparent").text("The same prototype structures:"):$("#sim_legend").removeClass("apparent").text("Similar "+m+":"),7<f&&$("#sim_trigger").attr("href",
"#interlinkage/"+a).show(),$("#sim_col > ul").html(g)):e?$("#sim_legend").addClass("apparent").text("No cross-links found"):"C"==b&&3==d?$("#sim_legend").addClass("apparent").html('<br /><a href="#entry/'+a.split("-")[0]+'"><img alt="C-entry" src="'+wmgui.static_host+"/pd_thumbs/"+a.split("-")[0]+'.png" /><br /><span>Full phase diagram</span></a>'):"C"==b&&5==d?$("#sim_legend").addClass("apparent").text("No links to other phases found"):"S"==b?$("#sim_legend").addClass("apparent").text("No other structures for this prototype found"):
$("#sim_legend").addClass("apparent").text("No similar values found");c.out.own.length&&!wmgui.search.phid&&$("#own_phase").html('<a href="#phase_id/'+c.out.own[0][1]+'"><img alt="Phase" src="'+wmgui.static_host+"/rd_thumbs/"+c.out.own[0][0]+'.png" /><br /><span>Linked '+("S"==b?"distinct phase":"crystalline structure")+"</span></a>").show()})).fail((function(a,b,c){"abort"!=b&&(429==a.status?wmgui.notify("Request rate limiting policy: please retry in a few seconds"):wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>"))}))}
...
function launch_iframed_app(a){var b=$(".busy_entry");if(b.length){var d=b.attr("id").substr(3),c=d.substr(0,1);"S"==c?(a=wmgui.v_player_addr+d,c=650):"P"==c?10==a?(a=wmgui.v_ab_vis_addr+d,c=600):(a=wmgui.v_sd_addr+d,c=550):(a=(wmgui.sid?wmgui.v_pd_addr:wmgui.v_pd_addr_anon)+d,c=600,d.startswith("C3")||d.startswith("C4")?wmgui.notify("This entry is now in preparation"):wmgui.entries_messages[d]&&wmgui.notify(wmgui.entries_messages[d]));wmgui.sid&&(a+="&sid="+wmgui.sid);d='<iframe frameborder=0 scrolling="no" width="100%" height="'+
c+'" src="'+a+'"></iframe>';d=wmgui.thumbed_display?'<div id="iframe" style="display:block;width:100%;border:1px solid #ddd;margin:10px 0;">'+d+"</div>":'<tr id="iframe"><td colspan="20" style="width:100%;padding:0;border-right:1px solid #eee;border-left:1px solid #eee;">'+d+"</td></tr>";b.after(d);$(window).scrollTop(b.position().top-95)}}
...
function manage_visavis(a,b,d){if(wmgui.visavis_terminating||!wmgui.visavis_working)return!1;if(wmgui.search.numeric)return wmgui.visavis_terminating=!0,!1;try{wmgui.active_ajax.abort()}catch(e){}try{wmgui.quick_ajax.abort()}catch(e){}rebuild_visavis();var c={total_count:1};$.extend(c,wmgui.search);document.getElementById("visavis_iframe").contentWindow.location.replace(get_visavis_url(c));a&&a(b,d);return!0}
function stop_visavis(){$("#visavis, #visavis_col").hide();wmgui.visavis_working=!1;wmgui.visavis_terminating=!1}function get_visavis_url(a){return"pie"==wmgui.visavis_curtype?wmgui.static_host+"/visavis/#"+wmgui.rfn_endpoint+"?q="+escape(JSON.stringify(a)):wmgui.static_host+"/visavis/#"+wmgui.vis_endpoint+"/"+wmgui.visavis_curtype+"?q="+escape(JSON.stringify(a))}
function describe_perms(a){var b="<h3>Web-browser access</h3><ul>",d="<h3>Programmatic access = API</h3><ul>";a.gui?a.gui.root?b+="<li>Complete access</li>":($.isArray(a.gui)||(a.gui=[a.gui]),$.each(a.gui,(function(c,d){if(3<c)return b+="<li>and "+(a.gui.length-4)+" more...</li>",!1;$.each(wmgui.facets,(function(a,c){if(d[c])try{b+='<li class="perms_view fct_'+c+'"><strong>'+wmgui.facet_names[c]+"</strong>: "+d[c].map((function(a){return a.replace(", "," &amp; ")})).join(", ")+"</li>"}catch(l){return!1}}));
b="ALL"==d.refs?b+"<li>Full access to reference details</li>":"MENTIONED"==d.refs?b+"<li>Access to corresponding references</li>":b+"<li>No access to reference details</li>";b+='<li style="font-size:0.8em;line-height:0.8em;"><br /></li>'}))):b+="<li>Only open data</li>";a.api?a.api.root?d+="<li>Complete access</li>":($.isArray(a.api)||(a.api=[a.api]),$.each(a.api,(function(b,e){if(3<b)return d+="<li>and "+(a.api.length-4)+" more...</li>",!1;$.each(wmgui.facets,(function(a,b){if(e[b])try{d+='<li class="perms_view fct_'+
b+'"><strong>'+wmgui.facet_names[b]+"</strong>: "+e[b].map((function(a){return a.replace(", "," &amp; ")})).join(", ")+"</li>"}catch(l){return!1}}));d+='<li style="font-size:0.8em;line-height:0.8em;"><br /></li>'}))):d+="<li>Only open data</li>";return b+'</ul><div class="divider"></div>'+d+"</ul>"}
...
($("a.plthint_links").each((function(){var a=$(this),d=a.attr("rev");a.attr("href",wmgui.gui_host+window.location.pathname+"#plot/"+d+"/"+window.location.hash.substr(1))})),$("#plthint").show()))}
function show_tooltip(a,b){if(!(a.view_mode!=wmgui.view_mode||wmgui.visavis_working&&!b||$("div.modal").is(":visible"))){b=1==wmgui.view_mode?$("#"+a.el).offset():$("#"+a.el).position();var d=document.getElementById("tooltip");d.style.left=b.left-a.oleft+"px";d.style.top=b.top+a.otop+"px";d.firstChild.innerHTML=a.text;document.getElementById("tooltip").style.display="block"}}
function user_login(a,b,d,c){var e=40<b.length?b.substr(0,37)+"&hellip;":b;$("#auth_user").html(e);$("#account_holder_name").text("Hi "+b+"!");$("#account_holder_acclogin > span").html('<a href="mailto:'+d+'">'+d+"</a>");wmgui.sid=a;$("div.logged_out").hide();$("div.logged_in").show();window.localStorage.setItem("wm",JSON.stringify({sid:a,name:b,acclogin:d,admin:c}));c?$("li.admin").show():$("li.admin").hide();document.getElementById("visavis_iframe").contentWindow.location.reload();communicate_windows("local_user_login");
...
function force_relogin(a){$.ajax({type:"POST",url:wmgui.logout_endpoint,data:{sid:wmgui.sid}}).done((function(a){})).fail((function(a,d,c){}));user_logout(!0);window.location.replace("#modal/login");a&&wmgui.notify(a)}function communicate_windows(a){window.localStorage.setItem("wm_reload",a);window.localStorage.removeItem("wm_reload")}
function update_dc(){var a=[],b={},d;for(d in wmgui.search)-1<["search_type","phid","numeric"].indexOf(d)||(b[d]=wmgui.search[d],a.push(wmgui.search[d]));a=a.join(" ");var c=0,e=JSON.stringify(b),g='<option value="X" selected>Last search...</option>';$.each(JSON.parse(window.localStorage.getItem("wm_search_log_v4")||"[]"),(function(a,b){if(5<c)return!1;a=[];var d=JSON.stringify(b);if(e==d)return!0;for(var f in b)a.push(b[f]);a=a.join(" ");g+='<option value="'+escape(d)+'">'+a+"</option>";c++}));g+=
...
function render_all_polyhedra(){if($("#all_polyhedra_content").is(":empty")){var a="",b=Object.keys(wmgui.aets);b.sort((function(a,b){var c=a.split("-vertex")[0].split(" ");c=parseInt(c[c.length-1]);var d=b.split("-vertex")[0].split(" ");d=parseInt(d[d.length-1]);return c>d?1:c<d?-1:a.length>b.length?1:a.length<b.length?-1:0}));$.each(b,(function(b,c){b=wmgui.aets[c];a+='<div class="gallery_item" rel="'+c+'"><div style="width:125px;height:'+b[1]+"px;margin:10px auto;background:url("+wmgui.aetmap_addr+
") 0 -"+b[0]+'px no-repeat;"></div><span>'+c+"</span></div>"}));$("#all_polyhedra_content").html(a)}}function assign_edition(){function a(a){a=parseInt(a);wmgui.editions[a]||(a=0);wmgui.edition=a;wmgui.loadCSS(wmgui.editions[a].css);wmgui.editions[a].actions&&wmgui.editions[a].actions()}$.each(wmgui.editions,(function(b,d){if(wmgui.gui_host==d.prod_url||wmgui.gui_host==d.dev_url)return a(b),!1}));wmgui.edition||a(0)};
var wmgui=window.wmgui||{};
...
onInitialize:function(){$("#search_field-selectized").focus()},onItemRemove:function(a){var d=this;wmgui.multiselects.main.read().numeric||destroy_numericbox();setTimeout((function(){d.close()}),750)},load:function(a,d){this.clearOptions();if(!a.length)return d();$.ajax({url:wmgui.auto_endpoint+"?q="+encodeURIComponent(a),type:"GET",error:d,success:function(a){a.length&&d(a)}})},score:function(){return function(){return 1}},render:{option:function(a,d){return'<div class="fct_'+a.facet+'">'+a.label+
"</div>"},item:function(a,d){return'<div class="fct_'+a.facet+'" data-facet="'+a.facet+'" data-term="'+a.label+'">'+a.label+"</div>"}}})[0].selectize;wmgui.multiselects.main.read=function(){return wmgui._selectize_read("main")};wmgui.multiselects.main.write=function(a){wmgui._selectize_write(wmgui.multiselects.main,"main",a)};wmgui.multiselects.main.display=function(a,d){wmgui._selectize_display(wmgui.multiselects.main,a,d)}};
