...
data:{new_password:b,sid:wmgui.sid},beforeSend:wmgui.show_preloader}).always((function(){$("#password_trigger").data("busy",!1);$("#password_trigger").text("Change");wmgui.hide_preloader()})).done((function(a){if(a.error)return wmgui.notify(a.error);user_login(a.sid,a.name,a.acclogin,a.admin);window.location.replace("#start");$("#account_pass_change").hide()})).fail((function(a,b,e){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))}}));$("#logout_trigger").click((function(){$.ajax({type:"POST",
url:wmgui.logout_endpoint,data:{sid:wmgui.sid}}).done((function(a){})).fail((function(a,b,c){}));user_logout();$("#userbox").trigger("click")}));$("#notifybox").on("click","span.relogin",force_relogin);$("#search_holder").keydown((function(a){13==(window.event?a.keyCode:a.which)&&$("#search_trigger").trigger("click")}));$("#intro_stats").on("click","li",(function(){var a=$(this).attr("rev");$(this).addClass("working").siblings().removeClass("working");$("div.introtab").hide();$("#"+a).show()}));$("#intro_stats").on("click",
"div.intro_rel",(function(){window.location.hash=$(this).attr("rel")}));$("#intro_stats").on("click","div.d",(function(){$("#advstab_options li").removeClass("working");$("#advstab_options li[rev=advstab_bib]").addClass("working");$("div.advstab").hide();$("#advstab_bib").show();show_advsbox()}));$("#control_a").click((function(){re_view_request(0)}));$("#control_b").click((function(){re_view_request(1)}));$("#control_f").click((function(){re_view_request(2)}));$("#control_c").click((function(){wmgui.visavis_terminating=
...
b,f=d.length?d.attr("id").split("_")[1]:b,g="",k="",h="";$("#ctxpanel_"+a+" > ul > li").each((function(){var c=$(this),d=c.attr("id").split("_")[1];c=c.contents().filter((function(){return 1!==this.nodeType}))[0].data.substr(3);var l=d==b?' class="ss_x"':"";g+='<li rev="ss_x" rel="x_'+d+'"'+l+">"+c+"</li>";l=d==e?' class="ss_y"':"";k+='<li rev="ss_y" rel="y_'+d+'"'+l+">"+c+"</li>";if("matrix"==a)return!0;l=d==f?' class="ss_z"':"";h+='<li rev="ss_z" rel="z_'+d+'"'+l+">"+c+"</li>"}));$("#ss_x > ul").html(g);
$("#ss_y > ul").html(k);"cube"==a&&$("#ss_z > ul").html(h);$("li.sops_x").removeClass("sops_x");$("li.sops_y").removeClass("sops_y");$("li.sops_z").removeClass("sops_z");var m=["x","y","z"];$("span.sops").each((function(){var a=$(this),b=a.text(),c=a.attr("rel");$("#sops_"+c+' > ul > li:contains("'+b+'")').addClass("sops_"+c);m=m.filter((function(a){return a!==c}))}));m.forEach((function(a){$("#sops_"+a+' > ul > li:contains("none")').addClass("sops_"+a)}));$("#ss_custom_box, #overlay").show()}));$("div.ss_col").on("click",
"li",(function(){var a=$(this),b=a.attr("rev"),c=a.attr("rel").split("_")[0];c="x"==c?"ss_x":"y"==c?"ss_y":"ss_z";$("#"+b+" > ul > li."+c).removeClass(c);a.addClass(c)}));$("div.sops_col").on("click","li",(function(){var a=$(this),b=a.parent().parent().attr("id"),c=b.split("_")[1];c="x"==c?"sops_x":"y"==c?"sops_y":"sops_z";$("#"+b+" > ul > li."+c).removeClass(c);a.addClass(c)}));$("#tips_trigger").click((function(){wmgui.tooltip_var=0;show_tooltip(wmgui.tooltips.search);return!1}));$("#numericbox").on("click",
"div.slider_close",(function(){if(1==$("div.slider_numerics").length)return destroy_numericbox(),delete wmgui.search.numeric,!1;var a=$(this);a.siblings("div.slider").children("div.slider_numerics")[0].noUiSlider.destroy();a.parent("li").fadeOut(250,(function(){$(this).remove()}))}));$("#numericbox_do_trigger").click((function(){$("#advsbox").is(":visible")?$("#advsearch_do_trigger").trigger("click"):$("#search_trigger").trigger("click")}));$("#numericbox_drop_trigger").click((function(){for(var a=document.getElementsByClassName("slider_numerics"),
b=0;b<a.length;b++){var c=a[b].noUiSlider.options.range;a[b].noUiSlider.set([c.min,c.max])}}));$("#close_numericbox").click((function(){destroy_numericbox();delete wmgui.search.numeric}));$(document).keydown((function(a){a=window.event?a.keyCode:a.which;13==a?(a=$(":focus"),a.hasClass("submitter")?a.parent().parent().find("div.def_submittable").trigger("click"):(a.hasClass("advs_input")||(a.attr("id")||"").startswith("advs_fct_"))&&$("#advsearch_do_trigger").trigger("click")):27==a&&(a=$("div.cross:visible"),
a.length&&a.trigger("click"))}));$(window).bind("hashchange",url_redraw_react);$(window).bind("storage",(function(a){if("wm_reload"==a.originalEvent.key&&(a=a.originalEvent.newValue)&&window[a])window[a]()}))};
var wmgui=window.wmgui||{};
