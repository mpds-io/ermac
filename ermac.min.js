...
a)window.location.hash="#plot/"+WMCORE.get_random_term(["pie","lit","graph"])+"/search/"+WMCORE.get_interesting().text;else if("sod"==a){var b=new Date;a=b.getDate()%wmgui.sbucks.length;var c=new Date(b.getFullYear(),0,0);b=b-c+6E4*(c.getTimezoneOffset()-b.getTimezoneOffset());window.location.hash="#entry/S"+(wmgui.sbucks[a]+Math.floor(b/864E5))}else"my"==a&&(a=JSON.parse(window.localStorage.getItem("wm")||"{}"),a.name&&(a=a.name.split(" "),window.location.hash="#inquiry/authors="+escape(a[a.length-
