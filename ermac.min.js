...
function z(a){a=$(a.bold());a.find("script").remove();return a.html()}function cancel_event(a){a=a||window.event;a.cancelBubble?a.cancelBubble=!0:(a.stopPropagation&&a.stopPropagation(),a.preventDefault&&a.preventDefault())}function debounce(a,b,e){var c;return function(){var g=this,f=arguments,d=e&&!c;clearTimeout(c);c=setTimeout((function(){c=null;e||a.apply(g,f)}),b);d&&a.apply(g,f)}}
function is_inview(a){var b=$(window).scrollTop(),e=b+$(window).height(),c=$(a).offset().top;a=c+$(a).height();return c<=e&&a>=b}Number.prototype.count_decimals=function(){return Math.floor(this.valueOf())===this.valueOf()?0:this.toString().split(".")[1].length||0};function show_preloader(){$("#preloader").show()}function hide_preloader(){$("#preloader").hide()}
function detect_IE(){var a=window.navigator.userAgent,b=a.indexOf("MSIE ");if(0<b)return parseInt(a.substring(b+5,a.indexOf(".",b)),10);if(0<a.indexOf("Trident/"))return b=a.indexOf("rv:"),parseInt(a.substring(b+3,a.indexOf(".",b)),10);b=a.indexOf("Edge/");return 0<b?parseInt(a.substring(b+5,a.indexOf(".",b)),10):!1}var ie_passing_check=(function(){var a=detect_IE();return a?12>a?!1:!0:!0})();if(!ie_passing_check)throw alert("Please, upgrade your browser"),Error("Unsupported user agent");
function loadCSS(a,b,e,c){function g(a){if(document.body)return a();setTimeout((function(){g(a)}))}function f(){d.addEventListener&&d.removeEventListener("load",f);d.media=e||"all"}var d=document.createElement("link");if(b)var h=b;else{var m=(document.body||document.getElementsByTagName("head")[0]).childNodes;h=m[m.length-1]}var n=document.styleSheets;if(c)for(var k in c)c.hasOwnProperty(k)&&d.setAttribute(k,c[k]);d.rel="stylesheet";d.href=a;d.media="only x";g((function(){h.parentNode.insertBefore(d,
b?h:h.nextSibling)}));var l=function(a){for(var b=d.href,c=n.length;c--;)if(n[c].href===b)return a();setTimeout((function(){l(a)}))};d.addEventListener&&d.addEventListener("load",f);d.onloadcssdefined=l;l(f);return d};
...
wmgui.numerics={volume:[5001,"&#8491;<sup>3</sup>",3,1E4,1],density:[5002,"Mg/m<sup>3</sup>",.1,30,.1],"a--b":[5003,!1,.1,10,!1,"<i>a/b</i>"],"b--c":[5004,!1,.1,10,!1,"<i>b/c</i>"],"c--a":[5005,!1,.1,10,!1,"<i>c/a</i>"],alat:[5006,"&#8491;",1.5,20,.1,"<i>a<sub>lat</sub></i>"],blat:[5007,"&#8491;",1.5,20,.1,"<i>b<sub>lat</sub></i>"],clat:[5008,"&#8491;",1.5,20,.1,"<i>c<sub>lat</sub></i>"]};
wmgui.desktop_motto=['based on the <a href="http://paulingfile.com" target="_blank" rel="noopener noreferrer">PAULING FILE</a> experimental inorganic database',"critically evaluated standardized data from the world's literature","the world's biggest high-quality online database of materials","the largest and most comprehensive inorganic materials dataset","peer-reviewed materials publications dated from 1891 until now"];
wmgui.mob_motto=["about 400K scientific publications and more than 20M data points","machine-readable materials data from the world's peer-reviewed literature","the world's biggest high-quality online database of materials","the largest and most comprehensive inorganic materials dataset","peer-reviewed materials publications dated from 1891 until now"];wmgui.gui_host=window.location.protocol+"//"+window.location.host;wmgui.api_host=wmgui.prod?"https://api.mpds.io/v0":"http://localhost:7070";
wmgui.static_host="https://mpds.io";wmgui.login_endpoint=wmgui.api_host+"/users/login";wmgui.logout_endpoint=wmgui.api_host+"/users/logout";wmgui.restore_endpoint=wmgui.api_host+"/users/lost_password";wmgui.password_endpoint=wmgui.api_host+"/users/new_password";wmgui.access_endpoint=wmgui.api_host+"/users/access";wmgui.ratify_endpoint=wmgui.api_host+"/users/ratify";wmgui.api_key_endpoint=wmgui.api_host+"/users/api_key";wmgui.perms_endpoint=wmgui.api_host+"/users/perms";
wmgui.funnel_endpoint=wmgui.api_host+"/users/funnel";wmgui.fd_endpoint=wmgui.api_host+"/users/feedback";wmgui.srch_endpoint=wmgui.api_host+"/search/facet";wmgui.rfn_endpoint=wmgui.api_host+"/search/refinement";wmgui.sim_endpoint=wmgui.api_host+"/search/interlinkage";wmgui.phph_endpoint=wmgui.api_host+"/search/phase_phid";wmgui.auto_endpoint=wmgui.api_host+"/search/selectize";wmgui.refs_endpoint=wmgui.api_host+"/download/bib";wmgui.vis_endpoint=wmgui.api_host+"/visavis";
wmgui.pdist_endpoint=wmgui.api_host+"/visavis/pdistribs";wmgui.dd_addr_tpl=wmgui.api_host+"/download";wmgui.v_player_addr=wmgui.static_host+"/player/player.html#"+wmgui.api_host+"/download/s?fmt=cif&q=";wmgui.v_pd_addr=wmgui.static_host+"/pd_stub.html#"+wmgui.api_host+"/download/c?fmt=png&q=";wmgui.v_pd_addr_anon=wmgui.static_host+"/visavis/?280420#"+wmgui.api_host+"/download/c?fmt=json&q=";wmgui.v_sd_addr=wmgui.static_host+"/visavis/?280420#"+wmgui.api_host+"/download/p?fmt=json&q=";
wmgui.v_ab_vis_addr=wmgui.static_host+"/labs/view-phonons/#"+wmgui.api_host+"/download/p?fmt=json&q=";wmgui.client_data_addr=wmgui.static_host+"/wmdata.json?040521";wmgui.aetmap_addr=wmgui.static_host+"/aets.jpg";wmgui.elemental_names={num:"atomic number",nump:"periodic number",size:"atomic size",rea:"atomic reactivity",rpp:"pseudopotential radii",rion:"ionic radii",rcov:"covalent radii",rmet:"metallic radii",tmelt:"melting temperature",eneg:"electronegativity"};
...
wmgui.sbucks=[251737,261485,301194,458778,525194,533193,1005414,1030546,1122968,1215422,1232477,1321212,1406036,1613664,1638591,1640622,1707997,1711681,1722027,1819191,1928624,1933647,1940797];wmgui.mockyear=(new Date).getFullYear();wmgui.edition=null;
wmgui.editions={0:{name:"Materials Platform for Data Science",prod_url:"https://mpds.io",dev_url:"http://localhost:8070",css:"/editions/wm/style.css?300121",actions:function(){$("#logo_l").text("MPDS")}},1:{name:"ASM International Materials Platform",prod_url:"https://asm.mpds.io",dev_url:"http://localhost:8075",css:"/editions/asm/style.css?300121",actions:function(){$("#subnav > ul > li.subnav_lpf").hide();$("#subnav > ul > li.subnav_asm").css("display","inline-block");var a=document.querySelector("link[rel*='icon']")||
document.createElement("link");a.type="image/x-icon";a.rel="shortcut icon";a.href="/editions/asm/asm.ico";document.getElementsByTagName("head")[0].appendChild(a)}}};
wmgui.tooltips={search:{el:"search_holder",oleft:-310,otop:60,view_mode:1,text:'Search here by <i>formula</i>, <i>elements</i>, <i>physical property</i>, <i>classes</i>, <i>lattice</i>, and <i>polyhedra</i>.<br /><span rel="advsearch">OK, next</span>'},advsearch:{el:"advsearch_init_trigger",oleft:90,otop:60,view_mode:1,text:'Use the &#9776; button for the detailed search by 15+ categories.<br /><span rel="hierarchy">OK, next</span>'},hierarchy:{el:"hierarchy_trigger",oleft:90,otop:60,view_mode:1,
text:'Use the <i>&mu;</i> button to select physical properties from the curated hierarchy.<br /><span rel="userbox">OK, next</span>'},userbox:{el:"userbox",oleft:100,otop:65,view_mode:1,text:'Access your account here and enjoy the full data access.<br /><span rel="close_tooltip">OK</span>'},interpretation:{el:"right_col",oleft:70,otop:99,view_mode:2,text:'The entries are grouped into the phases.<br /><span rel="databrowser">OK, next</span>'},databrowser:{el:"databrowser",oleft:0,otop:200,view_mode:2,
text:'Click the particular entry to get more info. Opened lock means open access.<br /><span rel="plots">OK, next</span>'},plots:{el:"databrowser",oleft:0,otop:500,view_mode:2,text:'Use the graph chart buttons in the footer (at the very bottom of the page).<br /><span rel="close_tooltip">OK</span>'},ss_axes:{el:"ctxpanel_plots",oleft:-60,otop:114,view_mode:2,text:'Click gear icon to sort axes differently.<br /><span rel="visavis" class="forced">OK, next</span>'},visavis:{el:"right_col",oleft:150,
otop:500,view_mode:2,text:'Fine-tune visualizations with these commands.<br /><span rel="close_tooltip">OK</span>'}};wmgui.tooltip_var=0;
...
function url__start(b){switch_view_mode(1);2>wmgui.tooltip_var&&setTimeout((function(){show_tooltip(wmgui.tooltips.search)}),4E3)}function url__search(b,a){b=unescape(b);var c=WMCORE.parse_string(b);c.numeric&&(wmgui.search_type=1);show_interpretation(c);delete c.ignored;$("#search_field-selectized").val("");wmgui.multiselects.main.clear();wmgui.multiselects.main.write(c);wmgui.search=c;c.search_type=wmgui.search_type;a||request_search(c,b,wmgui.search_type)}
function url__inquiry(b,a){var c=b.split("&").map(function(a){return a=a.split("="),this[a[0]]=a[1],this}.bind({}))[0];wmgui.facets.forEach((function(a){c[a]&&(c[a]=unescape(c[a].replaceAll("\\+"," ")))}));c.numeric&&(c.numeric=unescape(c.numeric).split(";").map((function(a){return a.split(",")})),wmgui.search_type=1);show_interpretation(c);delete c.ignored;var d=[];$.each(c,(function(a,b){d.push(b)}));$("#search_field-selectized").val("");wmgui.multiselects.main.clear();wmgui.multiselects.main.write(c);
wmgui.search=c;c.search_type=wmgui.search_type;a||request_search(c,d.join(" ").replaceAll(","," "),wmgui.search_type)}
...
var wmgui=window.wmgui||{};
function register_events(){$("#search_trigger").click((function(){var a=wmgui.multiselects.main.read(),b=$("#search_field-selectized").val(),c="",d=document.getElementsByClassName("slider_numerics");if(b){if(b.endswith(" ")||b.endswith(","))b=b.substr(0,b.length-1);b=WMCORE.parse_string(b);for(var e in b)"ignored"!=e&&(a[e]=a[e]&&"elements"==e?a[e]+("-"+b[e]):a[e]&&"classes"==e?a[e]+(", "+b[e]):b[e])}for(e=0;e<d.length;e++){b=d[e].noUiSlider.get();var f=d[e].getAttribute("rel");c+=serialize_numeric(f,
">",b[0])+serialize_numeric(f,"<",b[1])}c.length&&(a.numeric=c.substr(0,c.length-1),delete a.props);if($.isEmptyObject(a))return wmgui.notify("Unrecognized input"),!1;a=$.param(a);window.location.hash=="#inquiry/"+a&&(a="="==a.slice(-1)?a.substr(0,a.length-1):a+"=");window.location.hash="#inquiry/"+a;return!1}));$("#advsearch_do_trigger").click((function(){var a="",b="",c="",d=document.getElementsByClassName("slider_numerics"),e={};$.each(wmgui.simple_facets,(function(b,c){if(a=$("#advs_fct_"+c).val())"formulae"==
c?a=WMCORE.termify_formulae(a):"elements"==c?a=a.replaceAll(",","").replaceAll(" ","-"):"doi"==c?a=a.replace("http://dx.doi.org/","").replace("http://doi.org/","").trim():"codens"==c&&(a=wmgui.journal_converter.j2c(a)),e[c]=a}));$.each(wmgui.multi_facets,(function(c,d){a=wmgui.multiselects[d].read();a[d]&&(a=a[d],"authors"==d&&(a=a.replace(/'/g,"").replaceAll("\\."," ").replaceAll("\\b\\w{1}\\b","").trim()),e[d]=a);(b=$("#advs_fct_"+d+"-selectized").val())&&(e[d]=e[d]?e[d]+(", "+b):b)}));for(var f=0;f<
d.length;f++){var g=d[f].noUiSlider.get(),k=d[f].getAttribute("rel");c+=serialize_numeric(k,">",g[0])+serialize_numeric(k,"<",g[1])}c.length&&(e.numeric=c.substr(0,c.length-1));if($.isEmptyObject(e))return wmgui.notify("Search is empty");c=$.param(e);window.location.hash=="#inquiry/"+c&&(c="="==c.slice(-1)?c.substr(0,c.length-1):c+"=");window.location.hash="#inquiry/"+c}));$("#advsearch_drop_trigger").click((function(){$("input.advs_input").val("");$.each(wmgui.multi_facets,(function(a,b){$("#advs_fct_"+
b+"-selectized").val("");wmgui.multiselects[b].clear()}));$("#aetmap").hide();$("#aet_limit").prop("checked",!1);destroy_numericbox()}));$("#advsearch_init_trigger").click((function(){$("#advstab_options li").removeClass("working");$("#advstab_options li[rev=advstab_bib]").addClass("working");$("#advstab_bib").show();$("#advstab_main, #advstab_cry").hide();show_advsbox();return!1}));$("#search_box").on("click","#legend a",(function(){var a=$(this).text();window.location.hash="#search/"+escape(a);return!1}));
$("div.advs_legend > a").click((function(){var a=$(this),b=a.text(),c=a.parent().data("multiselects");c?($("#advs_fct_"+c+"-selectized").val(""),wmgui.multiselects[c].clear(),a={},a[c]=b,wmgui.multiselects[c].write(a)):a.parent().parent().children("input").val(b).focus();return!1}));$("#databrowser").on("mousedown","a.resolve_ref",(function(a){a=$(this).attr("rel");$("a.resolve_ref[rel="+a+"]").addClass("visited");wmgui.bid_history.push(parseInt(a));window.localStorage.setItem("bid_history",JSON.stringify(wmgui.bid_history));
return!0}));$("#databrowser").on("click","tr.tcell, div.gallery_item",(function(){open_context($(this),!1)}));$("#databrowser").on("click","span.launch_v",(function(a){cancel_event(a);a=$(this).parent().parent();a.removeClass("busy_entry");open_context(a,!0)}));$("#databrowser").on("click","a.launch_ph",(function(a){cancel_event(a);a=$(this).attr("href");window.location.hash==a&&(a+=".");window.location.hash=a;return!1}));$("#all_polyhedra_content").on("click","div.gallery_item",(function(){$("#advstab_options li").removeClass("working");
...
c=wmgui.poly_limits[c.length];if(!c)return cancel_event(a),wmgui.notify("Sorry, only up to 3 supported"),!1;-1==b.indexOf(c)&&wmgui.multiselects.classes.write({classes:c})}else{var d=Object.values(wmgui.poly_limits);wmgui.multiselects.classes.clear();wmgui.multiselects.classes.write({classes:b.filter((function(a){return-1==d.indexOf(a)})).join(", ")})}return!0}));$("#visualize").click((function(){close_vibox()||launch_iframed_app(this.getAttribute("data-rank"))}));$("#refine_col").on("click","a.extd_refine",
(function(){var a=$(this).attr("rel");if($("#refine_col > ul > li.extd_rfns.fct_"+a).length)return $("#refine_col > ul > li:not(.fct_"+a+")").addClass("hidden_rfns").slideUp(),$("#refine_col > ul > li.extd_rfns.fct_"+a).show(),$("a.extd_refine[rel="+a+"]").parent().hide(),!1;var b={extd_refine:a};$.extend(b,wmgui.search);try{wmgui.active_ajax.abort()}catch(c){}wmgui.active_ajax=$.ajax({type:"GET",url:wmgui.rfn_endpoint,data:{q:JSON.stringify(b)}}).done((function(c){if(c.error)return wmgui.notify(c.error);
var d="";delete b.numeric;delete b.extd_refine;var e=!1;$.each(wmgui.inquiries,(function(a,c){if(b[c])return e=!0,!1}));$.each(c.payload,(function(c,g){var f="",h={};$.each(b,(function(b,c){if("search_type"==b||"elements"==a&&("elements"==b||"formulae"==b)||"props"==a&&"props"==b)return!0;f+=c+" ";h[b]=h[b]?h[b]+(", "+c):c}));"props"==a&&(g[0]=g[0].replace(/\(|\)/g,"").replace(/\/[\w\-]*/g,""));h[a]=h[a]?h[a]+(", "+g[0]):g[0];h.elements&&(h.elements=h.elements.replaceAll(", ","-"));d=e?d+('<li class="extd_rfns fct_'+
a+'"><a href="#inquiry/'+$.param(h)+'">'+g[0]+"</a></li>"):d+('<li class="extd_rfns fct_'+a+'"><a href="#search/'+f+g[0]+'">'+g[0]+"</a></li>")}));d+='<li class="extd_rfns fct_'+a+' collapse_refine"><a class="collapse_refine" rel="'+a+'" href="#">Show less</a></li>';$("#refine_col > ul > li:not(.fct_"+a+")").addClass("hidden_rfns").slideUp();$("a.extd_refine[rel="+a+"]").parent().hide().after(z(d))})).fail((function(a,b,e){"abort"!=b&&wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>")}));
return!1}));$("#refine_col").on("click","a.collapse_refine",(function(){var a=$(this).attr("rel");$("a.extd_refine[rel="+a+"]").parent().show();$("#refine_col > ul > li.hidden_rfns").removeClass("hidden_rfns").slideDown(250);$("#refine_col > ul > li.extd_rfns").hide();return!1}));$("#fdwidget").on("click","span",(function(){"fdwidget_yes"==$(this).attr("id")?$("#fdwidget").html("We appreciate your feedback!"):($("#fdwidget").html(wmgui.contact_html),$("#fdwidget_msg").focus())}));$("#fdwidget").on("click",
"div.wmbutton",(function(){$(this).data("busy")||($(this).data("busy",!0),$.ajax({type:"POST",url:wmgui.fd_endpoint,data:{fdwidget_msg:$("#fdwidget_msg").val(),fdwidget_msgtype:$("#fdwidget_msgtype").val(),fdwidget_url:window.location.href},beforeSend:show_preloader}).always(hide_preloader).done((function(a){$("#fdwidget_trigger").data("busy",!1);if(a.error)return wmgui.notify(a.error);$("#fdwidget").html("We appreciate your feedback!")})).fail((function(a,b,c){wmgui.notify("Sorry, cannot process your input")})))}));
$("#tagcloudbox").on("click","a.collateral",(function(){$("#userbox").data("saved_hash",!1);var a=$(this).attr("rel");if("adv"==a)$("#advsearch_init_trigger").trigger("click"),$("div.menu_collateral").hide();else if("idea"==a)window.location.hash="#plot/"+WMCORE.get_random_term(["pie","lit","graph"])+"/search/"+WMCORE.get_interesting().text;else if("sod"==a){var b=new Date;a=b.getDate()%wmgui.sbucks.length;var c=new Date(b.getFullYear(),0,0);b=b-c+6E4*(c.getTimezoneOffset()-b.getTimezoneOffset());
window.location.hash="#entry/S"+(wmgui.sbucks[a]+Math.floor(b/864E5))}else"my"==a&&(a=JSON.parse(window.localStorage.getItem("wm")||"{}"),a.name&&(a=a.name.split(" "),window.location.hash="#inquiry/authors="+escape(a[a.length-1])));return!1}));$("#hintsbox_msg").on("click","div.wmbutton",(function(){var a=document.createRange();a.selectNode($("#hintsbox_msg > pre").get(0));window.getSelection().removeAllRanges();window.getSelection().addRange(a);document.execCommand("copy");wmgui.notify("Copied")}));
...
$("#close_inquiry_dialogue").click((function(){$("#inquirybox").hide()}));$("#close_ss_dialogue").click((function(){var a=$("#ss_x > ul > li.ss_x").attr("rel").split("_")[1],b=$("#ss_y > ul > li.ss_y").attr("rel").split("_")[1],c=$("#sops_x > ul > li.sops_x").text(),d=$("#sops_y > ul > li.sops_y").text();c="none"==c?!1:c;d="none"==d?!1:d;if($("#ss_z").is(":visible")){var e=$("#ss_z > ul > li.ss_z").attr("rel").split("_")[1],f=$("#sops_z > ul > li.sops_z").text();f="none"==f?!1:f;$("#ctxpanel_cube > ul > li.embodied").removeClass("embodied");
$("#viscube_"+a).addClass("embodied");$("#ctxpanel_cube > ul > li.ss_y").removeClass("ss_y");$("#viscube_"+b).addClass("ss_y");$("#ctxpanel_cube > ul > li.ss_z").removeClass("ss_z");$("#viscube_"+e).addClass("ss_z");$("span.sops").remove();c&&$('<span class="sops" rel="x">'+c+"</span>").appendTo("#viscube_"+a);d&&$('<span class="sops" rel="y">'+d+"</span>").appendTo("#viscube_"+b);f&&$('<span class="sops" rel="z">'+f+"</span>").appendTo("#viscube_"+e);-1!==document.getElementById("visavis_iframe").contentWindow.location.hash.indexOf("fixel=1")?
document.getElementById("visavis_iframe").contentWindow.matrix_order(a,b,c,d):document.getElementById("visavis_iframe").contentWindow.cube_order(a,b,e,c,d,f)}else{if(c&&"count"==a||d&&"count"==b)return wmgui.notify("Sorry, data counts are not supported");$("#ctxpanel_matrix > ul > li.embodied").removeClass("embodied");$("#vismatrix_"+a).addClass("embodied");$("#ctxpanel_matrix > ul > li.ss_y").removeClass("ss_y");$("#vismatrix_"+b).addClass("ss_y");$("span.sops").remove();c&&$('<span class="sops" rel="x">'+
...
$("#close_formal_dialogue").click((function(){window.location.hash="#start"}));$("#close_product_dialogue, #close_ph_dialogue, div.close_hy_dialogue").click((function(){if(-1==document.referrer.indexOf(window.location.host))window.location.hash="#start";else{var a=window.location.href;window.history.go(-1);setTimeout((function(){window.location.href==a&&(window.location.hash="#start")}),500)}}));$("div._close_ctx").click((function(){try{wmgui.quick_ajax.abort()}catch(a){}$(".busy_entry").removeClass("busy_entry");
$("#ctx_col, #sim_col").hide();wmgui.passive_sim_col=!0;close_vibox()}));$("#inquiry_gui_trigger, #inquiry_api_trigger").click((function(){$("#inquirybox").show()}));$("#funnel_trigger").click((function(){var a=$(this);a.data("busy")||(a.data("busy",!0).text("Sending..."),$.ajax({type:"POST",url:wmgui.funnel_endpoint,data:{firstname:$("#funnel_firstname").val(),lastname:$("#funnel_lastname").val(),org:$("#funnel_org").val(),email:$("#funnel_email").val(),phone:$("#funnel_phone").val(),users:$("#funnel_users").val(),
ed:wmgui.edition},beforeSend:show_preloader}).always((function(){$("#funnel_trigger").data("busy",!1).text("Submit");hide_preloader()})).done((function(a){if(a.error)return wmgui.notify(a.error);$("#funnel_gui_lead, #funnel_api_lead, #inquirybox").slideUp().parent().children("div.funnel_msg").hide();wmgui.notify("Thanks, we have received your request")})).fail((function(a,c,d){wmgui.notify("Sorry, an error occured. Please, contact <a href='mailto:support@tilde.pro'>support@tilde.pro</a>")})))}));$("#hy_box").on("click",
"span",(function(){var a=$(this).attr("class");$("span."+a).each((function(){var a=$(this);a.parent().find("ul").toggle();"expand"==a.text()?a.text("collapse"):a.text("expand")}))}));$("#hy_box").on("click","a.dynprop",(function(){if(1==wmgui.view_mode)return!0;var a=$(this).attr("data-val");window.location.hash=wmgui.aug_search_cmd("props",a);return!1}));$("#hy_box").on("click","strong.numeric",(function(){var a=$(this).attr("rel"),b=wmgui.numerics[a],c=b[0],d=b[1],e=b[2],f=b[3];b=b[4];var g=$("div.slider_numerics").length;
2<=g&&wmgui.notify("Too little phases have all these properties reported &mdash; expect no results");8<=g||create_floating_slider(a,c,d,e,f,b)}));$("strong.numeric").click((function(){var a=$(this).attr("rel"),b=wmgui.numerics[a];create_floating_slider(a,b[0],b[1],b[2],b[3],b[4])}));$("#hy_options > li").click((function(){var a=$(this),b=a.attr("rev");"hy_vis"==b?window.open(wmgui.static_host+"/labs/ontology"):(a.addClass("working").siblings().removeClass("working"),$("div.hy_tabs").hide(),$("#"+b).show())}));
$("#dtypes > ul > li").click((function(){var a=$(this),b=a.data("facet");a=a.data("term");"classes"==b&&wmgui.search.classes&&(wmgui.search.classes=wmgui.search.classes.replace("peer-reviewed","").replace("peer-review","").replace("machine-learning","").replace("machine learning","").replace("ab initio calculations","").split(",").map((function(a){return a.trim()})).filter((function(a){return a})).join(", "));window.location.hash=wmgui.aug_search_cmd(b,a)}));$(window).scroll(debounce((function(){if(2==wmgui.view_mode&&
wmgui.unfinished_page&&50>$("#footer").offset().top-$(window).scrollTop()-$(window).height()){if(!wmgui.unfinished_page)return;wmgui.unfinished_page=!1;var a={offset:wmgui.quick_page_size};$.extend(a,wmgui.search);wmgui.active_ajax=$.ajax({type:"GET",url:wmgui.srch_endpoint,data:{q:JSON.stringify(a),sid:wmgui.sid},beforeSend:show_preloader}).always(hide_preloader).done((function(a){if(a.error)return wmgui.notify(a.error);$("div.context_msg").hide();show_hints();a.out.length&&(wmgui.thumbed_display?
$("#databrowser tr td").append(build_thumbs(a.out)):($("#databrowser tbody").append(build_cells(a.out)),$("#databrowser").trigger("update")))})).fail((function(a,c,d){"abort"!=c&&wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>")}))}a=$("#iframe");a.length&&!is_inview(a)&&close_vibox()}),300));$("#userbox").click((function(){var a=$(this);window.location.hash==a.data("saved_hash")&&a.data("saved_hash",!1);a.data("saved_hash")?(window.location.replace(a.data("saved_hash")),
a.data("saved_hash",!1)):-1!==window.location.hash.indexOf("modal")?window.location.replace("#start"):(a.data("saved_hash",window.location.hash),wmgui.sid?window.location.replace("#modal/menu"):window.location.replace("#modal/login"))}));$("span.href[rel]").click((function(){window.location.replace($(this).attr("rel"))}));$("#interpret").on("click","li",(function(){var a=$(this),b=a.attr("rel");b?window.location.hash=b:(a=a.attr("class"),-1<a.indexOf("numeric")?window.location.hash="#hierarchy":-1<a.indexOf("authors")||
-1<a.indexOf("years")||-1<a.indexOf("codens")||-1<a.indexOf("doi")||-1<a.indexOf("geos")||-1<a.indexOf("orgs")?($("#advstab_options li").removeClass("working"),$("#advstab_options li[rev=advstab_bib]").addClass("working"),$("div.advstab").hide(),$("#advstab_bib").show(),show_advsbox()):-1<a.indexOf("formulae")||-1<a.indexOf("props")||-1<a.indexOf("elements")||-1<a.indexOf("classes")?($("#advstab_options li").removeClass("working"),$("#advstab_options li[rev=advstab_main]").addClass("working"),$("div.advstab").hide(),
$("#advstab_main").show(),show_advsbox()):($("#advstab_options li").removeClass("working"),$("#advstab_options li[rev=advstab_cry]").addClass("working"),$("div.advstab").hide(),$("#advstab_cry").show(),show_advsbox(),wmgui.search.aetypes&&show_aetmap(wmgui.search.aetypes)))}));$("#tab_links > li").click((function(){try{wmgui.active_ajax.abort()}catch(c){}try{wmgui.quick_ajax.abort()}catch(c){}var a=$(this),b=a.attr("rev");a.addClass("working").siblings().removeClass("working");$("div.menu_tabs").hide();
$("#"+b).show();"usr_tab_api_key"==b?($("#hintsbox_msg").html(wmgui.api_msg),wmgui.active_ajax=$.ajax({type:"POST",url:wmgui.api_key_endpoint,data:{sid:wmgui.sid},beforeSend:show_preloader}).always(hide_preloader).done((function(a){if(a.error)return wmgui.notify(a.error);$("#usr_api_key").html(a.msg);if(a.revokable)$("#revoke_usr_api_key_holder").show();else if(a.creatable)$("#create_usr_api_key_holder").show();else return wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')})).fail((function(a,
b,e){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))):"usr_tab_perms"==b?($("#hintsbox_msg").html(WMCORE.get_random_term(wmgui.welcomes)),wmgui.active_ajax=$.ajax({type:"POST",url:wmgui.perms_endpoint,data:{sid:wmgui.sid},beforeSend:show_preloader}).always(hide_preloader).done((function(a){if(a.error)return wmgui.notify(a.error);if(!a.hasOwnProperty("gui")||!a.hasOwnProperty("api"))return wmgui.notify('Login error: please, <span class="href relogin">re-login</span>');
$("#perms_view").html(describe_perms(a))})).fail((function(a,b,e){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))):"usr_tab_ctrl"==b?window.location.href=wmgui.static_host+(0===wmgui.edition?"/ctrl":"/labs/custom-datasets")+"?"+Math.floor(1E3*Math.random()):"usr_tab_account"==b&&$("#hintsbox_msg").html(WMCORE.get_random_term(wmgui.welcomes))}));$("#advstab_options > li").click((function(){var a=$(this),b=a.attr("rev");a.addClass("working").siblings().removeClass("working");
$("div.advstab").hide();$("#"+b).show()}));$("#producttab_options > li").click((function(){var a=$(this),b=a.attr("rev"),c=-1==b.indexOf("api")?"api":"gui",d="gui"==c?"api":"gui";$("#funnel_"+c+"_email").val()&&$("#funnel_"+d+"_email").val($("#funnel_"+c+"_email").val());$("#funnel_"+c+"_name").val()&&$("#funnel_"+d+"_name").val($("#funnel_"+c+"_name").val());a.addClass("working").siblings().removeClass("working");$("div.product_types").hide();$("#"+b).show()}));$("a.link_adjuster").click((function(){return"#polyhedra"==
window.location.hash?(window.location.hash="#polyhedra/",!1):"#polyhedra/"==window.location.hash?(window.location.hash="#polyhedra",!1):!0}));$("#create_usr_api_key").click((function(){$(this).parent().hide();try{wmgui.active_ajax.abort()}catch(a){}wmgui.active_ajax=$.ajax({type:"POST",url:wmgui.api_key_endpoint,data:{sid:wmgui.sid,create:!0},beforeSend:show_preloader}).always(hide_preloader).done((function(a){if(a.error)return wmgui.notify(a.error);$("#usr_api_key").html(a.msg);$("#revoke_usr_api_key_holder").show()})).fail((function(a,
b,c){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))}));$("#revoke_usr_api_key").click((function(){$(this).parent().hide();try{wmgui.active_ajax.abort()}catch(a){}wmgui.active_ajax=$.ajax({type:"POST",url:wmgui.api_key_endpoint,data:{sid:wmgui.sid,revoke:!0},beforeSend:show_preloader}).always(hide_preloader).done((function(a){if(a.error)return wmgui.notify(a.error);$("#usr_api_key").html("Successfully revoked");$("#create_usr_api_key_holder").show()})).fail((function(a,
b,c){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))}));$("#login_trigger").click((function(){if(!$(this).data("busy")){$(this).data("busy",!0);$(this).text("In process...");try{wmgui.active_ajax.abort()}catch(a){}wmgui.active_ajax=$.ajax({type:"POST",url:wmgui.login_endpoint,data:{login:$("#login_email").val().trim(),pass:$("#login_password").val()},beforeSend:show_preloader}).always((function(){$("#login_trigger").data("busy",!1);$("#login_trigger").text("Login");
...
$.ajax({type:"POST",url:wmgui.restore_endpoint,data:{login:$("#restore_by_email").val().trim(),ed:wmgui.edition},beforeSend:show_preloader}).always((function(){$("#restore_trigger").data("busy",!1);$("#restore_trigger").text("Send link");hide_preloader()})).done((function(a){if(a.error)return wmgui.notify(a.error);wmgui.notify("Please, check your inbox (and spam)");$("#userbox").trigger("click")})).fail((function(a,b,c){"abort"!=b&&wmgui.notify("A network error occured. Please, try again")}))}}));$("#account_holder_accpass > span").click((function(){$("#account_pass_change").toggle()}));
$("#password_trigger").click((function(){var a=$("#new_password_1").val(),b=$("#new_password_2").val();if(!a||!b)return wmgui.notify("Please, type your new password in both fields");if(a!==b)return wmgui.notify("Passwords do not match (typo?)");if(!$(this).data("busy")){$(this).data("busy",!0);$(this).text("Changing...");try{wmgui.active_ajax.abort()}catch(c){}wmgui.active_ajax=$.ajax({type:"POST",url:wmgui.password_endpoint,data:{new_password:b,sid:wmgui.sid},beforeSend:show_preloader}).always((function(){$("#password_trigger").data("busy",
!1);$("#password_trigger").text("Change");hide_preloader()})).done((function(a){if(a.error)return wmgui.notify(a.error);user_login(a.sid,a.name,a.acclogin,a.admin);window.location.replace("#start");$("#account_pass_change").hide()})).fail((function(a,b,e){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))}}));$("#logout_trigger").click((function(){$.ajax({type:"POST",url:wmgui.logout_endpoint,data:{sid:wmgui.sid}}).done((function(a){})).fail((function(a,b,c){}));user_logout();
$("#userbox").trigger("click")}));$("#notifybox").on("click","span.relogin",force_relogin);$("#search_holder").keydown((function(a){13==(window.event?a.keyCode:a.which)&&$("#search_trigger").trigger("click")}));$("#intro_stats").on("click","li",(function(){var a=$(this).attr("rev");$(this).addClass("working").siblings().removeClass("working");$("div.introtab").hide();$("#"+a).show()}));$("#intro_stats").on("click","div.intro_rel",(function(){window.location.hash=$(this).attr("rel")}));$("#intro_stats").on("click",
"div.d",(function(){$("#advstab_options li").removeClass("working");$("#advstab_options li[rev=advstab_bib]").addClass("working");$("div.advstab").hide();$("#advstab_bib").show();show_advsbox()}));$("#control_a").click((function(){re_view_request(0)}));$("#control_b").click((function(){re_view_request(1)}));$("#control_f").click((function(){re_view_request(2)}));$("#control_c").click((function(){wmgui.visavis_terminating=!0;wmgui.thumbed_display=!1;if(wmgui.visavis_working){var a={},b;for(b in wmgui.search)-1<
...
$(this).attr("id").substr(8);"matrix"==a?($("#ss_z, #sops_z").hide(),$("#ss_x, #ss_y, #sops_x, #sops_y").css("width","50%")):($("#ss_x, #ss_y, #ss_z, #sops_x, #sops_y, #sops_z").css("width","33%"),$("#ss_z, #sops_z").show());var b=$("#ctxpanel_"+a+" > ul > li.embodied").attr("id").split("_")[1],c=$("#ctxpanel_"+a+" > ul > li.ss_y"),d=$("#ctxpanel_"+a+" > ul > li.ss_z"),e=c.length?c.attr("id").split("_")[1]:b,f=d.length?d.attr("id").split("_")[1]:b,g="",k="",h="";$("#ctxpanel_"+a+" > ul > li").each((function(){var c=
$(this),d=c.attr("id").split("_")[1];c=c.contents().filter((function(){return 1!==this.nodeType}))[0].data.substr(3);var l=d==b?' class="ss_x"':"";g+='<li rev="ss_x" rel="x_'+d+'"'+l+">"+c+"</li>";l=d==e?' class="ss_y"':"";k+='<li rev="ss_y" rel="y_'+d+'"'+l+">"+c+"</li>";if("matrix"==a)return!0;l=d==f?' class="ss_z"':"";h+='<li rev="ss_z" rel="z_'+d+'"'+l+">"+c+"</li>"}));$("#ss_x > ul").html(g);$("#ss_y > ul").html(k);"cube"==a&&$("#ss_z > ul").html(h);$("li.sops_x").removeClass("sops_x");$("li.sops_y").removeClass("sops_y");
$("li.sops_z").removeClass("sops_z");var m=["x","y","z"];$("span.sops").each((function(){var a=$(this),b=a.text(),c=a.attr("rel");$("#sops_"+c+' > ul > li:contains("'+b+'")').addClass("sops_"+c);m=m.filter((function(a){return a!==c}))}));m.forEach((function(a){$("#sops_"+a+' > ul > li:contains("none")').addClass("sops_"+a)}));$("#ss_custom_box, #overlay").show()}));$("div.ss_col").on("click","li",(function(){var a=$(this),b=a.attr("rev"),c=a.attr("rel").split("_")[0];c="x"==c?"ss_x":"y"==c?"ss_y":"ss_z";
$("#"+b+" > ul > li."+c).removeClass(c);a.addClass(c)}));$("div.sops_col").on("click","li",(function(){var a=$(this),b=a.parent().parent().attr("id"),c=b.split("_")[1];c="x"==c?"sops_x":"y"==c?"sops_y":"sops_z";$("#"+b+" > ul > li."+c).removeClass(c);a.addClass(c)}));$("#tips_trigger").click((function(){wmgui.tooltip_var=0;show_tooltip(wmgui.tooltips.search);return!1}));$("#numericbox").on("click","div.slider_close",(function(){if(1==$("div.slider_numerics").length)return destroy_numericbox(),delete wmgui.search.numeric,
!1;var a=$(this);a.siblings("div.slider").children("div.slider_numerics")[0].noUiSlider.destroy();a.parent("li").fadeOut(250,(function(){$(this).remove()}))}));$("#numericbox_do_trigger").click((function(){$("#advsbox").is(":visible")?$("#advsearch_do_trigger").trigger("click"):$("#search_trigger").trigger("click")}));$("#numericbox_drop_trigger").click((function(){for(var a=document.getElementsByClassName("slider_numerics"),b=0;b<a.length;b++){var c=a[b].noUiSlider.options.range;a[b].noUiSlider.set([c.min,
c.max])}}));$("#close_numericbox").click((function(){destroy_numericbox();delete wmgui.search.numeric}));$(document).keydown((function(a){a=window.event?a.keyCode:a.which;13==a?(a=$(":focus"),a.hasClass("submitter")?a.parent().parent().find("div.def_submittable").trigger("click"):(a.hasClass("advs_input")||(a.attr("id")||"").startswith("advs_fct_"))&&$("#advsearch_do_trigger").trigger("click")):27==a&&(a=$("div.cross:visible"),a.length&&a.trigger("click"))}));$(window).bind("hashchange",url_redraw_react);
$(window).bind("storage",(function(a){if("wm_reload"==a.originalEvent.key&&(a=a.originalEvent.newValue)&&window[a])window[a]()}))};
var wmgui=window.wmgui||{};
...
var wmgui=window.wmgui||{};wmgui.notify=function(a){var b=0;wmgui.notify_counter&&(clearInterval(wmgui.notify_counter),wmgui.notify_counter=null,b=1500);setTimeout((function(){$("#notifybox").html(z(a)).show();wmgui.notify_counter=setTimeout((function(){$("#notifybox").hide()}),5E3)}),b)};
wmgui.aug_search_cmd=function(a,b){for(var e=[["elements","formulae"],["formulae","elements"],["lattices","sgs"],["sgs","lattices"],["protos","sgs"],["sgs","protos"],["lattices","protos"],["protos","lattices"]],d=0;d<e.length;d++)if(wmgui.search[e[d][0]]&&a==e[d][1]){delete wmgui.search[e[d][0]];break}var f=!1;$.each(wmgui.inquiries,(function(d,c){if(wmgui.search[c]||c==a)return f=!0,!1}));if(f){var g={};$.each(wmgui.facets,(function(d,c){wmgui.search[c]&&c==a?-1!==wmgui.multi_facets.indexOf(c)?g[c]=
wmgui.search[c]+","+b:g[c]=b:wmgui.search[c]?g[c]=wmgui.search[c]:c==a&&(g[c]=b)}));return"#inquiry/"+$.param(g)}var c="";$.each(wmgui.facets,(function(d,e){wmgui.search[e]&&e==a?c="classes"==e?c+(wmgui.search[e]+" "+b+" "):c+(b+" "):wmgui.search[e]?c+=wmgui.search[e]+" ":e==a&&(c+=b+" ")}));return"#search/"+c.substr(0,c.length-1)};
wmgui._selectize_read=function(a){var b={},e="#search_holder";"main"!==a&&(e="div.advs_"+a);$(e+" div.selectize-input.items").children().each((function(){if("DIV"==this.tagName){var a=this.getAttribute("data-facet");-1!==wmgui.other_facets.indexOf(a)&&wmgui.search[a]?b[a]=wmgui.search[a]:"numeric"==a?wmgui.search[a]&&(b[a]="",wmgui.search[a].forEach((function(d){b[a]+=serialize_numeric.apply(this,d)})),b[a].length&&(b[a]=b[a].substr(0,b[a].length-1))):b[a]&&"elements"==a?b[a]+="-"+this.getAttribute("data-term"):
b[a]&&-1!==wmgui.multi_facets.indexOf(a)?b[a]+=", "+this.getAttribute("data-term"):b[a]="formulae"==a?this.getAttribute("data-term").replaceAll("<sub>","").replaceAll("</sub>",""):this.getAttribute("data-term")}}));return b};
wmgui._selectize_write=function(a,b,e){var d={};$.extend(d,e);if("main"==b){b="formulae props elements classes lattices aetypes".split(" ");for(e=0;e<wmgui.other_facets.length;e++)d[wmgui.other_facets[e]]&&a.display(wmgui.other_facets[e],wmgui.facet_names[wmgui.other_facets[e]].toLowerCase());d.numeric&&a.display("numeric","range search")}else b=[b];b.forEach((function(b){d[b]&&("elements"==b&&0<d[b].indexOf("-")?d[b].split("-").forEach((function(d){a.display(b,d)})):-1!==wmgui.multi_facets.indexOf(b)&&
0<d[b].indexOf(",")?d[b].split(",").forEach((function(d){a.display(b,d)})):("formulae"==b&&(d[b]=WMCORE.to_formula(d[b])),a.display(b,d[b])))}));a.clearOptions()};wmgui._selectize_display=function(a,b,e){var d=Math.floor(1E3*Math.random());a.addOption({facet:b,label:e,id:d});a.addItem(d)};function show_interpretation(a){$("#interpret").html(z(WMCORE.get_interpretation(a,wmgui.facet_names,wmgui.numerics)))}
function re_view_request(a){var b=[];$.each(wmgui.search,(function(a,d){if("search_type"==a)return!0;b.push(d)}));b.length&&(wmgui.search_type=a,wmgui.search.search_type=a,request_search(wmgui.search,b.join(" "),!0))}
function request_search(a,b,e){if(!manage_visavis(rebuild_history_box,a,b)){try{wmgui.active_ajax.abort()}catch(d){}try{wmgui.quick_ajax.abort()}catch(d){}wmgui.active_ajax=$.ajax({type:"GET",url:wmgui.srch_endpoint,data:{q:JSON.stringify(a),sid:wmgui.sid},beforeSend:show_preloader}).always(hide_preloader).done((function(d){if(d.error)return wmgui.notify(d.error);b=b.replaceAll("%2F","/");if(!d.out.length)return wmgui.notify("No results for <b>"+b+"</b>");wmgui.fuzzyout=!1;d.fuzzy_notice&&(wmgui.fuzzyout=
!0,wmgui.notify(d.fuzzy_notice));document.title=(150<d.estimated_count?"At least ":"")+d.estimated_count+(1==d.estimated_count?" result":" results");switch_view_mode(2);wmgui.chosen_table_browser||(wmgui.thumbed_display=d.out.length>wmgui.ntab_tolerance);if(wmgui.thumbed_display){var f=$("#databrowser");f.removeClass().addClass("thumbed").empty().append("<tr><td>"+build_thumbs(d.out)+"</td></tr>");$("#results").slideDown(250)}else f=$("#databrowser"),f.removeClass().addClass("tabled").empty().append(build_cells(d.out,
...
show_hints(a.entry||a.interlinkage)):d.estimated_count>wmgui.quick_page_size+wmgui.fetch_page_size?($("#toomuch span").html("nearly "+(d.estimated_count-wmgui.quick_page_size)).parent().show(),show_hints(a.entry)):d.estimated_count>wmgui.quick_page_size?($("#loadscroll").show(),wmgui.unfinished_page=!0):show_hints(a.entry);wmgui.visavis_terminating&&stop_visavis();wmgui.search_type||a.phid||a.entry||a.interlinkage||a.doi||a.numeric?($("#dtypes").hide(),display_examples("#examples",!0,!0),a.phid||
a.entry||a.interlinkage?switch_control_mode(9,11,"a","c"):a.numeric?(switch_control_mode(1,12,"b",!1),destroy_numericbox(),$.each(get_sliders_ranges(a.numeric,wmgui.numerics),(function(a,c){create_floating_slider.apply(this,c)}))):switch_control_mode(1,10,!1,!1),a.entry&&"S"==a.entry.substr(0,1)&&(d=$("#e__"+a.entry),d.removeClass("busy_entry"),open_context(d,!0))):($("#dtypes").show(),wmgui.fuzzyout?switch_control_mode(1,11,"a",!1):switch_control_mode(0,10,!1,!1),request_refinement(a,d.estimated_count>
wmgui.quick_page_size));a.numeric||destroy_numericbox();a.props&&wmgui.numerics[a.props]&&(d=wmgui.numerics[a.props],create_floating_slider(a.props,d[0],d[1],d[2],d[3],d[4]));e||rebuild_history_box(a,b)})).fail((function(a,b,e){"abort"!=b&&wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>")}))}}
function rebuild_history_box(a,b){var e={};wmgui.facets.forEach((function(c){a[c]&&(e[c]=a[c])}));var d=!1;$.each(wmgui.inquiries,(function(a,c){if(e[c])return d=!0,!1}));var f=[];for(g in e)f.push(e[g].toLowerCase());f.sort();var g=f.join(" ");f=JSON.parse(window.localStorage.getItem("wm_search_log_v4")||"[]");var c=[];8<f.length&&(f=f.slice(0,7));$.each(f,(function(a,b){a=[];for(var d in b)a.push(b[d].toLowerCase());a.sort();c.push(a.join(" "))}));-1==c.indexOf(g)&&(b=d?'<a href="#inquiry/'+$.param(e)+
'">'+b+"</a>":'<a href="#search/'+escape(b)+'">'+b+"</a>",$("#history ul").prepend("<li>"+z(b)+"</li>"),f.unshift(e),window.localStorage.setItem("wm_search_log_v4",JSON.stringify(f)),8<$("#history ul li").length&&$("#history ul li:last").remove());wmgui.tooltip_var++;1==wmgui.tooltip_var&&setTimeout((function(){show_tooltip(wmgui.tooltips.interpretation)}),3E3)}
function rebuild_visavis(){var a=window.location.hash.indexOf("search/");if(-1==a&&(a=window.location.hash.indexOf("inquiry/"),-1==a))return;var b=window.location.hash.substr(a);$("a.pltcol_links").each((function(){var a=$(this),e=a.attr("rev");a.attr("href",window.location.protocol+"//"+window.location.host+window.location.pathname+"#plot/"+e+"/"+b)}));$("#visavis_col > ul > li").removeClass("embodied");$("#pltchoice_"+wmgui.visavis_curtype).addClass("embodied");-1<["matrix","cube","discovery"].indexOf(wmgui.visavis_curtype)&&
...
$("span.sops").remove()}else"graph"==wmgui.visavis_curtype&&($("#ctxpanel_graph > ul > li.embodied").removeClass("embodied"),$("#visgraph_props").addClass("embodied"));document.getElementById("visavis_iframe").contentWindow.fixel_manage("cube"==wmgui.visavis_curtype&&wmgui.search.elements)}function rotate_interesting(){$("#legend").html('<i>e.g.</i> <a href="#">'+WMCORE.get_interesting().text.replace(/\d/g,"&#x208$&;")+"</a>")}
function display_examples(a,b,e){null===wmgui.cliff_counter&&(wmgui.cliff_counter=Math.floor(Math.random()*wmgui.cliffhangers.length));for(var d="",f=0;f<(b?12:3);f++)wmgui.cliff_counter+=1,wmgui.cliff_counter>wmgui.cliffhangers.length-1&&(wmgui.cliff_counter=0),d+='<li><a href="#search/'+WMCORE.termify_formulae(wmgui.cliffhangers[wmgui.cliff_counter])+'">'+wmgui.cliffhangers[wmgui.cliff_counter].charAt(0).toUpperCase()+wmgui.cliffhangers[wmgui.cliff_counter].slice(1)+"</a></li>";$(a+" > ul").empty().append(d);
$(a).show();e&&($("#refine_col > div.col_title, #refine_col > ul").hide(),$("#refine_col").show())}
function arrange_menu_collateral(){$("#hintsbox_msg, #tagcloudbox").empty();for(var a="",b=0;b<wmgui.collateral_links.length;b++){var e=wmgui.collateral_links[b][1],d=wmgui.collateral_links[b][1]?"collateral":!1,f="",g="";b%2&&(d=d?d+" violet":"violet",g="<br />");wmgui.collateral_links[b][3]&&(f=' target="_blank"');a+="<a"+f+' href="'+wmgui.collateral_links[b][0]+'"'+(d?' class="'+d+'"':"")+(e?" rel="+e:"")+">"+wmgui.collateral_links[b][2]+"</a>"+g}$("#tagcloudbox").append(a);$("#hintsbox_msg").append(WMCORE.get_random_term(wmgui.welcomes))}
function switch_view_mode(a){wmgui.view_mode=a;$("div.autocomplete-suggestions").hide();$("#results, #header_entries, #header_phases, #header_articles").hide();$("div.context_msg").hide();close_vibox();1==a?(stop_visavis(),document.title="MPDS materials platform",$("body").addClass("noscroll"),$("#search_box").removeClass("fluid").css("background","none").css("width","590px"),$("div.side_cols").hide(),$("#landing_box, #intro_stats, #subnav, #legend").show(),$("#search_holder").removeClass("prolonged").focus(),
$("#search_area").removeClass("prolonged"),$("#ermac_logo").removeClass("cornered")):2==a&&($("#landing_box, #intro_stats, #subnav, #legend").hide(),$("#ctx_col").hide(),wmgui.passive_sim_col&&$("#sim_col").hide(),$("body").removeClass("noscroll"),$("#search_box").css("background","#fff").css("width","100%").addClass("fluid"),$("#right_col").show(),$("#search_holder, #search_area").addClass("prolonged"),$("#ermac_logo").addClass("cornered"))}
...
"100%").show());b&&(e||(e={0:"a",1:"b",2:"f"}[wmgui.search_type]),d||(d=wmgui.thumbed_display?"d":"c"),$("div.controlswitch > div").removeClass(),$("#control_"+e+", #control_"+d).addClass("active"),switch_control_mode(b))}
function build_cells(a,b,e){var d={7:" ml_data",8:" ab_data",9:" ab_data",10:" ab_data",11:" ab_data"},f="";b&&(f+=b);if(2==wmgui.search_type){if(6!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";$.each(a,(function(a,c){c[0]=parseInt(c[0]);999999==c[0]&&(c[4]=wmgui.mockyear);f+='<tr id="e__B'+c[0]+'" class="tcell" data-type="B"><td class=c55>[<a class="resolve_ref'+(-1<wmgui.bid_history.indexOf(c[0])?" visited":"")+'" href="'+wmgui.refs_endpoint+
"?ref_id="+c[0]+"&sid="+wmgui.sid+"&ed="+wmgui.edition+'" rel="'+c[0]+'" target="_blank" rel="noopener noreferrer">'+c[0]+"</a>]</td><td class=a1>"+c[1]+'</td><td class=a2 title="'+c[2]+'">'+c[2]+"</td><td class=a5>"+c[5]+"</td><td class=cj>"+c[3]+"</td><td class=c4>"+c[4]+"</td></tr>"}))}else if(1==wmgui.search_type){if(5!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";$.each(a,(function(a,c){f+='<tr id="e__Z'+c[0]+'" class="tcell" data-type="Z"><td class=p1>'+
c[1]+"</td><td class=p2>"+c[2]+"</td><td class=p3>"+c[3]+"</td><td class=p4>"+c[4]+'</td><td class=p5><a class=launch_ph href="#phase_id/'+c[0]+'">Show entries</a></td></tr>'}))}else{if(8!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";$.each(a,(function(a,c){c[7]=parseInt(c[7]);a=c[0].substr(0,1);var b=4==c[3]||5==c[3]||6==c[3]||9==c[3]||10==c[3]?"<span class=launch_v>Show</span>":" ",e=999999==c[7]?"<td class=cj>&mdash;</td><td class=c4>"+
wmgui.mockyear+"</td><td class=c5>&mdash;</td>":"<td class=cj>"+c[5]+"</td><td class=c4>"+c[6]+'</td><td class=c5>[<a class="resolve_ref'+(-1<wmgui.bid_history.indexOf(c[7])?" visited":"")+'" href="'+wmgui.refs_endpoint+"?ref_id="+c[7]+"&sid="+wmgui.sid+"&ed="+wmgui.edition+'" rel="'+c[7]+'" target="_blank" rel="noopener noreferrer">'+c[7]+"</a>]</td>";f+='<tr id="e__'+c[0]+'" class="tcell'+(d[c[3]]||"")+(c[4]?" opened":"")+'" data-type="'+a+'" data-rank="'+c[3]+'" title="Click for more info"><td class=c1>'+
c[1]+"</td><td class=cp>"+b+"</td><td class=c2>"+c[2]+"</td>"+e+"</tr>"}))}e&&(f+=e);return f}
function build_thumbs(a){var b={6:" pd_full",7:" ml_data",8:" ab_data",9:" ab_data",10:" ab_data",11:" ab_data"},e="";if(2==wmgui.search_type){if(6!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";a.sort((function(a,c){return a[4]>c[4]?1:a[4]<c[4]?-1:0}));var d="",f=!!wmgui.sid;$.each(a,(function(a,c){c[0]=parseInt(c[0]);999999==c[0]&&(c[4]=wmgui.mockyear);d=f?(60<c[1].length?c[1].substr(0,60)+"&hellip;":c[1])+", <span>"+(80<c[2].length?
...
2)+"</a>]</div></div>"}))}else if(1==wmgui.search_type){if(5!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";a.sort((function(a,c){return a[1]>c[1]?1:a[1]<c[1]?-1:0}));$.each(a,(function(a,c){e+='<div class="gallery_item" id="e__Z'+c[0]+'" data-type="Z"><div class="gallery_img"><div class="phased">'+c[1]+"<br /><br />SG "+c[2]+'</div></div><div class="gallery_label"><a class=launch_ph href="#phase_id/'+c[0]+'">Show '+c[3]+(1==c[3]?
" entry":" entries")+"</a><br />Publications: "+c[4]+"</div></div>"}))}else{if(8!=a[0].length)return wmgui.notify("Rendering error, please try to <a href=javascript:location.reload()>reload</a>"),"";a.sort((function(a,c){var b=a[0].substr(0,1),d=c[0].substr(0,1);if("S"==b)return"S"==d?a[1]>c[1]?1:a[1]<c[1]?-1:0:-1;if("C"==b){if("C"==d)return a[1]>c[1]?1:a[1]<c[1]?-1:0;if("S"==d)return 1;if("P"==d)return-1}if("P"==b)return"P"==d?a[2].toUpperCase()>c[2].toUpperCase()?1:a[2].toUpperCase()<c[2].toUpperCase()?
-1:0:1}));$.each(a,(function(a,c){c[7]=parseInt(c[7]);a=c[0].substr(0,1);var d=999999==c[7]?"<br />&mdash;":'<br />[<a class="resolve_ref'+(-1<wmgui.bid_history.indexOf(c[7])?" visited":"")+'" href="'+wmgui.refs_endpoint+"?ref_id="+c[7]+"&sid="+wmgui.sid+"&ed="+wmgui.edition+'" rel="'+c[7]+'" target="_blank" rel="noopener noreferrer">'+c[5]+"&rsquo;"+c[6].toString().substr(2,2)+"</a>]";if("P"==a)var f="<div>"+c[2]+"</div>";else"S"==a?f='<img alt="'+c[0]+'" src="'+wmgui.static_host+"/rd_thumbs/"+c[0].split("-")[0]+
'.png" />':(c[2]=c[2].split(";")[0],c[2]=c[2].split(" ")[c[2].split(" ").length-1],f='<img alt="'+c[0]+'" src="'+wmgui.static_host+"/pd_thumbs/"+c[0].split("-")[0]+'.png" /><p>'+c[2]+"</p>");e+='<div class="gallery_item'+(b[c[3]]||"")+(c[4]?" opened":"")+'" id="e__'+c[0]+'" data-type="'+a+'" data-rank="'+c[3]+'" title="Click for more info"><div class="gallery_img">'+f+'</div><div class="gallery_label">'+c[1]+d+"</div></div>"}))}return e}
function request_refinement(a,b){$("#examples").hide();$("#refine_col > ul").empty().parent().show();$("#refine_col > div.col_title").show();var e={is_heavy:b};$.extend(e,a);try{wmgui.active_ajax.abort()}catch(d){}wmgui.active_ajax=$.ajax({type:"GET",url:wmgui.rfn_endpoint,data:{q:JSON.stringify(e)},beforeSend:function(){$("#rfn_preloader").show()}}).always((function(){$("#rfn_preloader").hide()})).done((function(d){if(d.error)return wmgui.notify(d.error);var f=null,g="",c=[],l=0;delete e.is_heavy;e.classes&&
(c=e.classes.split(",").map((function(a){return a.trim()})),e.classes=c.join(","));var m=!1;$.each(wmgui.inquiries,(function(a,c){if(e[c])return m=!0,!1}));$.each(d.payload,(function(d,h){if(a.formulae&&"elements"==h.facet)return!0;var n="",p=!1,k={};$.each(e,(function(a,c){if(-1<["search_type","phid","numeric"].indexOf(a)||"elements"==h.facet&&("elements"==a||"formulae"==a)||"props"==h.facet&&"props"==a)return!0;n+=c+" ";k[a]=k[a]?k[a]+(", "+c):c}));a.classes&&"classes"==h.facet&&$.each(c,(function(a,c){if(c==
h.value)return p=!0,!1}));if(p)return!0;h.facet!=f&&(f&&b&&(g+='<li class="fct_'+f+' extd_refine"><a class="extd_refine" rel="'+f+'" href="#">Show more&nbsp;</a></li>'),g+='<li class="new_rfn_facet fct_'+h.facet+'">'+wmgui.facet_names[h.facet]+"</li>",f=h.facet);"props"==h.facet&&(h.value=h.value.replace(/\(|\)/g,"").replace(/\/[\w\-]*/g,""));k[h.facet]=k[h.facet]?k[h.facet]+(", "+h.value):h.value;k.elements&&(k.elements=k.elements.replaceAll(", ","-"));g=m?g+('<li class="fct_'+h.facet+'"><a href="#inquiry/'+
$.param(k)+'">'+h.value+"</a></li>"):g+('<li class="fct_'+h.facet+'"><a href="#search/'+n+h.value+'">'+h.value+"</a></li>");l++}));b&&(g+='<li class="fct_'+f+' extd_refine"><a class="extd_refine" rel="'+f+'" href="#">Show more&nbsp;</a></li>');0==l?display_examples("#examples",!0,!0):($("#refine_col > ul").show().append(z(g)),10>=l&&display_examples("#examples",!1,!1))})).fail((function(a,b,e){"abort"!=b&&(429==a.status?wmgui.notify("Request rate limiting policy: please retry in a few seconds"):wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>"))}))}
function open_context(a,b){close_vibox();if(a.hasClass("busy_entry")){a.removeClass("busy_entry");$("#ctx_col, #sim_col").hide();try{wmgui.quick_ajax.abort()}catch(c){}}else{var e=a.attr("id").substr(3),d=parseInt(a.attr("data-rank")),f=e.substr(0,1),g=e.split("-")[0];$(".busy_entry").removeClass("busy_entry");a.addClass("busy_entry");"Z"!=f&&"B"!=f&&($("#entryno").html('<a href="#entry/'+g+'">'+g+"</a>"),$("#ctx_col").show(),$("#visualize, div.spinoff_pane, li.d_icon").hide(),open_sim_col(e,f,d),
0==d?$("#download_bib").show():1==d?$("#download_bib, #download_pdf").show():2==d?$("#download_bib, #download_pdf, #download_json").show():3==d?$("#download_bib, #download_png, #download_cdr").show():4==d?($("#visualize").attr("data-rank",d),$("#download_bib, #download_json, #visualize").show()):5==d?($("#visualize").attr("data-rank",d),$("#download_bib, #download_pdf, #visualize, #download_cif, #download_inp, #download_json").show()):6==d?($("#visualize").attr("data-rank",d),$("#download_bib, #download_pdf, #visualize, #download_png, #download_cdr, #download_json").show()):
7==d?$("#ml_data, #download_pdf, #download_json").show():8==d?$("#ab_data, #download_pdf, #download_json, #download_raw").show():9==d?($("#visualize").attr("data-rank",d),$("#ab_data, #download_pdf, #download_json, #visualize, #download_png, #download_raw").show()):10==d?($("#visualize").attr("data-rank",d),$("#ab_data, #download_pdf, #download_json, #visualize, #download_raw").show()):11==d&&$("#ab_promise, #download_json").show(),$("#ctx_col > ul > li.d_icon:visible > a").each((function(){var a=
$(this).attr("rel"),b="S"==f?"&export=1":"",d="raw"==a?"null":wmgui.sid;a=wmgui.dd_addr_tpl+"/"+f.toLowerCase()+"?q="+e+"&fmt="+a+"&sid="+d+b+"&ed="+wmgui.edition;$(this).attr("href",a)})),b&&launch_iframed_app(d))}}
function open_sim_col(a,b,e){$("#sim_col > ul, #sim_legend").empty();$(".sim_col_ctx").hide();$("#sim_col").show();var d={q:a},f=-1<[0,1,4,9].indexOf(e);f&&(d.allpurpose=!0);try{wmgui.quick_ajax.abort()}catch(g){}wmgui.quick_ajax=$.ajax({type:"GET",url:wmgui.sim_endpoint,data:d,beforeSend:function(){$("#sim_preloader").show()}}).always((function(){$("#sim_preloader").hide()})).done((function(d){if(d.error)return wmgui.notify(d.error);var c=0,g="";if(f)$.each(d.out.sim,(function(a,b){if(7==c)return!1;
g=b[4]?g+('<li><a href="#inquiry/'+$.param({elements:b[1],years:b[2],codens:b[3],classes:1==b[4]?"":b[4]})+'">'+b[0]+"</a></li>"):g+('<li><a href="#inquiry/'+$.param({formulae:b[1],years:b[2],codens:b[3]})+'">'+b[0]+"</a></li>");c++}));else if("C"==b||"S"==b)3<e&&($.each(d.out.sim,(function(a,b){if(8==c)return!1;g+='<li><a href="#phase_id/'+b[1]+'">'+b[0]+"</a></li>";c++})),"C"==b&&$("#pd_legend").show());else{var m=wmgui.thumbed_display?$("div.busy_entry > div.gallery_img > div").text().split(";")[0]:
$("tr.busy_entry > td.c2").text().split(";")[0];$.each(d.out.sim,(function(a,b){if(8==c)return!1;g+='<li><a href="#search/'+m+" "+b[1]+'">'+b[0]+"</a></li>";c++}))}c?(f?$("#sim_legend").removeClass("apparent").text("Also studied by these authors:"):"C"==b?$("#sim_legend").removeClass("apparent").text("Phases at the diagram:"):"S"==b?$("#sim_legend").removeClass("apparent").text("The same prototype structures:"):$("#sim_legend").removeClass("apparent").text("Similar "+m+":"),7<c&&$("#sim_trigger").attr("href",
"#interlinkage/"+a).show(),$("#sim_col > ul").html(g)):f?$("#sim_legend").addClass("apparent").text("No cross-links found"):"C"==b&&3==e?$("#sim_legend").addClass("apparent").html('<br /><a href="#entry/'+a.split("-")[0]+'"><img alt="C-entry" src="'+wmgui.static_host+"/pd_thumbs/"+a.split("-")[0]+'.png" /><br /><span>Full phase diagram</span></a>'):"C"==b&&5==e?$("#sim_legend").addClass("apparent").text("No links to other phases found"):"S"==b?$("#sim_legend").addClass("apparent").text("No other structures for this prototype found"):
$("#sim_legend").addClass("apparent").text("No similar values found");d.out.own.length&&!wmgui.search.phid&&$("#own_phase").html('<a href="#phase_id/'+d.out.own[0][1]+'"><img alt="Phase" src="'+wmgui.static_host+"/rd_thumbs/"+d.out.own[0][0]+'.png" /><br /><span>Linked '+("S"==b?"distinct phase":"crystalline structure")+"</span></a>").show()})).fail((function(a,b,d){"abort"!=b&&(429==a.status?wmgui.notify("Request rate limiting policy: please retry in a few seconds"):wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>"))}))}
...
function launch_iframed_app(a){var b=$(".busy_entry");if(b.length){var e=b.attr("id").substr(3),d=e.substr(0,1);"S"==d?(a=wmgui.v_player_addr+e,d=650):"P"==d?10==a?(a=wmgui.v_ab_vis_addr+e,d=600):(a=wmgui.v_sd_addr+e,d=550):(a=(wmgui.sid?wmgui.v_pd_addr:wmgui.v_pd_addr_anon)+e,d=600,e.startswith("C3")||e.startswith("C4")?wmgui.notify("This entry is now in preparation"):wmgui.entries_messages[e]&&wmgui.notify(wmgui.entries_messages[e]));wmgui.sid&&(a+="&sid="+wmgui.sid);e='<iframe frameborder=0 scrolling="no" width="100%" height="'+
...
function start_visavis(a){destroy_numericbox();a&&(wmgui.visavis_curtype=a);$("div.ctxpanel").hide();a=$("#ctxpanel_"+wmgui.visavis_curtype);a.length&&a.show();-1<["matrix","cube","discovery"].indexOf(wmgui.visavis_curtype)&&$("#cmppanel_plots").show();if(wmgui.visavis_working)return manage_visavis();rebuild_visavis();$("#visavis_col").show();$("#visavis").show();switch_control_mode(0,11,"a","e");$("body").addClass("noscroll");wmgui.search_type=0;wmgui.visavis_working=!0;wmgui.visavis_starting=!1;
a={total_count:1};$.extend(a,wmgui.search);document.getElementById("visavis_iframe").contentWindow.location.replace(get_visavis_url(a))}
function manage_visavis(a,b,e){if(wmgui.visavis_terminating||!wmgui.visavis_working)return!1;if(wmgui.search.numeric)return wmgui.visavis_terminating=!0,!1;try{wmgui.active_ajax.abort()}catch(f){}try{wmgui.quick_ajax.abort()}catch(f){}rebuild_visavis();var d={total_count:1};$.extend(d,wmgui.search);document.getElementById("visavis_iframe").contentWindow.location.replace(get_visavis_url(d));a&&a(b,e);return!0}
function stop_visavis(){$("#visavis, #visavis_col").hide();wmgui.visavis_working=!1;wmgui.visavis_terminating=!1}function get_visavis_url(a){return"pie"==wmgui.visavis_curtype?wmgui.gui_host+"/visavis/#"+wmgui.rfn_endpoint+"?q="+escape(JSON.stringify(a)):wmgui.gui_host+"/visavis/#"+wmgui.vis_endpoint+"/"+wmgui.visavis_curtype+"?q="+escape(JSON.stringify(a))}
function describe_perms(a){var b="<h3>Web-browser access</h3><ul>",e="<h3>Programmatic access = API</h3><ul>";a.gui?a.gui.root?b+="<li>Complete access</li>":($.isArray(a.gui)||(a.gui=[a.gui]),$.each(a.gui,(function(d,e){if(3<d)return b+="<li>and "+(a.gui.length-4)+" more...</li>",!1;$.each(wmgui.facets,(function(a,c){if(e[c])try{b+='<li class="perms_view fct_'+c+'"><strong>'+wmgui.facet_names[c]+"</strong>: "+e[c].map((function(a){return a.replace(", "," &amp; ")})).join(", ")+"</li>"}catch(l){return!1}}));
b="ALL"==e.refs?b+"<li>Full access to reference details</li>":"MENTIONED"==e.refs?b+"<li>Access to corresponding references</li>":b+"<li>No access to reference details</li>";b+='<li style="font-size:0.8em;line-height:0.8em;"><br /></li>'}))):b+="<li>Only open data</li>";a.api?a.api.root?e+="<li>Complete access</li>":($.isArray(a.api)||(a.api=[a.api]),$.each(a.api,(function(b,f){if(3<b)return e+="<li>and "+(a.api.length-4)+" more...</li>",!1;$.each(wmgui.facets,(function(a,b){if(f[b])try{e+='<li class="perms_view fct_'+
b+'"><strong>'+wmgui.facet_names[b]+"</strong>: "+f[b].map((function(a){return a.replace(", "," &amp; ")})).join(", ")+"</li>"}catch(l){return!1}}));e+='<li style="font-size:0.8em;line-height:0.8em;"><br /></li>'}))):e+="<li>Only open data</li>";return b+'</ul><div class="divider"></div>'+e+"</ul>"}
...
function show_hints(a){$("#fdwidget").html('Were you satisfied with the data quality? Did everything work as expected? <span id="fdwidget_yes">Yes</span><span id="fdwidget_no">No</span>').show();a||wmgui.search.numeric||wmgui.search.doi||wmgui.search.phid||wmgui.fuzzyout||2==wmgui.search_type||(a={},$.extend(a,wmgui.search),delete a.ignored,delete a.search_type,a=JSON.stringify(a).replaceAll(" ","+").replace("{","\\{").replace("}","\\}"),$("#apihint span").html(a).parent().show(),wmgui.search.search_type||
($("a.plthint_links").each((function(){var a=$(this),e=a.attr("rev");a.attr("href",window.location.protocol+"//"+window.location.host+window.location.pathname+"#plot/"+e+"/"+window.location.hash.substr(1))})),$("#plthint").show()))}
function show_tooltip(a,b){if(!(a.view_mode!=wmgui.view_mode||wmgui.visavis_working&&!b||$("div.modal").is(":visible"))){b=1==wmgui.view_mode?$("#"+a.el).offset():$("#"+a.el).position();var e=document.getElementById("tooltip");e.style.left=b.left-a.oleft+"px";e.style.top=b.top+a.otop+"px";e.firstChild.innerHTML=a.text;document.getElementById("tooltip").style.display="block"}}
function user_login(a,b,e,d){var f=40<b.length?b.substr(0,37)+"&hellip;":b;$("#auth_user").html(f);$("#account_holder_name").text("Hi "+b+"!");$("#account_holder_acclogin > span").html('<a href="mailto:'+e+'">'+e+"</a>");wmgui.sid=a;$("div.logged_out").hide();$("div.logged_in").show();window.localStorage.setItem("wm",JSON.stringify({sid:a,name:b,acclogin:e,admin:d}));d?$("li.admin").show():$("li.admin").hide();document.getElementById("visavis_iframe").contentWindow.location.reload();communicate_windows("local_user_login");
wmgui.notify("You are logged in")}function local_user_login(){var a=JSON.parse(window.localStorage.getItem("wm")||"{}");a.sid!=wmgui.sid&&a.sid&&a.name&&a.acclogin&&user_login(a.sid,a.name,a.acclogin,a.admin)}
function user_logout(a){wmgui.sid&&(wmgui.sid=null,$("li.admin").hide(),$("div.logged_in").hide(),$("div.logged_out").show(),window.localStorage.removeItem("wm"),document.getElementById("visavis_iframe").contentWindow.location.reload(),communicate_windows("user_logout"),a||wmgui.notify("You are logged out"))}
function force_relogin(a){$.ajax({type:"POST",url:wmgui.logout_endpoint,data:{sid:wmgui.sid}}).done((function(a){})).fail((function(a,e,d){}));user_logout(!0);window.location.replace("#modal/login");a&&wmgui.notify(a)}function communicate_windows(a){window.localStorage.setItem("wm_reload",a);window.localStorage.removeItem("wm_reload")}
function update_dc(){var a=[],b={},e;for(e in wmgui.search)-1<["search_type","phid","numeric"].indexOf(e)||(b[e]=wmgui.search[e],a.push(wmgui.search[e]));a=a.join(" ");var d=0,f=JSON.stringify(b),g='<option value="X" selected>Last search...</option>';$.each(JSON.parse(window.localStorage.getItem("wm_search_log_v4")||"[]"),(function(a,b){if(5<d)return!1;a=[];var c=JSON.stringify(b);if(f==c)return!0;for(var e in b)a.push(b[e]);a=a.join(" ");g+='<option value="'+escape(c)+'">'+a+"</option>";d++}));g+=
'<option value="Y">No comparison</option>';$("#select_cmp_trigger").empty().append(g)}function show_aetmap(a){(a=wmgui.aets[a])?$("#aetmap").css("height",a[1]+"px").css("background","url("+wmgui.aetmap_addr+") 0 -"+a[0]+"px no-repeat").show():$("#aetmap").hide()}
function render_all_polyhedra(){if($("#all_polyhedra_content").is(":empty")){var a="",b=Object.keys(wmgui.aets);b.sort((function(a,b){var d=a.split("-vertex")[0].split(" ");d=parseInt(d[d.length-1]);var e=b.split("-vertex")[0].split(" ");e=parseInt(e[e.length-1]);return d>e?1:d<e?-1:a.length>b.length?1:a.length<b.length?-1:0}));$.each(b,(function(b,d){b=wmgui.aets[d];a+='<div class="gallery_item" rel="'+d+'"><div style="width:125px;height:'+b[1]+"px;margin:10px auto;background:url("+wmgui.aetmap_addr+
") 0 -"+b[0]+'px no-repeat;"></div><span>'+d+"</span></div>"}));$("#all_polyhedra_content").html(a)}}function rotate_motto(){$("#motto > span").animate({opacity:"hide"},3500,(function(){$("#motto > span").html(wmgui.desktop_motto[Math.floor(Math.random()*wmgui.desktop_motto.length)]).animate({opacity:"show"},2500,(function(){setTimeout(rotate_motto,2500)}))}))}
function assign_edition(){function a(a){a=parseInt(a);wmgui.editions[a]||(a=0);wmgui.edition=a;loadCSS(wmgui.editions[a].css);wmgui.editions[a].actions&&wmgui.editions[a].actions()}var b=wmgui.prod?"prod_url":"dev_url";$.each(wmgui.editions,(function(e,d){if(d[b]==window.location.protocol+"//"+window.location.host)return a(e),!1}));wmgui.edition||a(0)};
var wmgui=window.wmgui||{};
...
c,d){b=b.toLowerCase();var e=[],f=0,h=[],g=0,k=a[c].length;for(g;g<k&&!(a[c][g].startswith(b)&&(e.push(a.props_ref[g]),h.push(a.props_ref[g]),f++,18<f));g++);if(6>e.length)for(g=0;g<k&&!(-1!=a[c][g].indexOf(b)&&-1==h.indexOf(a.props_ref[g])&&(e.push(a.props_ref[g]),f++,18<f));g++);d(e)},renderItem:function(a,c){return'<div class="autocomplete-suggestion" style="'+(wmgui.numerics[a]?"color:#c00":"")+'" data-val="'+a+'">'+a+"</div>"},onSelect:function(a,c,d){a=wmgui.numerics[c];$("#numericbox").is(":visible")&&
a?create_floating_slider(c,a[0],a[1],a[2],a[3],a[4]):window.location.hash=wmgui.aug_search_cmd("props",c);$("#hy_suggest").val("")}});rotate_interesting();setInterval(rotate_interesting,2E3);$("#motto > span").html(wmgui.desktop_motto[Math.floor(Math.random()*wmgui.desktop_motto.length)]);setTimeout(rotate_motto,2500);window.location.hash?url_redraw_react():window.location.replace("#start")}));wmgui.multiselects.main=$("#search_field").selectize({plugins:["remove_button","preserve_on_blur"],valueField:"id",
labelField:"label",searchField:"label",create:!1,highlight:!1,maxItems:10,closeAfterSelect:!0,diacritics:!1,options:[],onInitialize:function(){$("#search_field-selectized").focus()},onItemRemove:function(a){var d=this;wmgui.multiselects.main.read().numeric||destroy_numericbox();setTimeout((function(){d.close()}),750)},load:function(a,d){this.clearOptions();if(!a.length)return d();$.ajax({url:wmgui.auto_endpoint+"?q="+encodeURIComponent(a),type:"GET",error:d,success:function(a){a.length&&d(a)}})},score:function(){return function(){return 1}},
render:{option:function(a,d){return'<div class="fct_'+a.facet+'">'+a.label+"</div>"},item:function(a,d){return'<div class="fct_'+a.facet+'" data-facet="'+a.facet+'" data-term="'+a.label+'">'+a.label+"</div>"}}})[0].selectize;wmgui.multiselects.main.read=function(){return wmgui._selectize_read("main")};wmgui.multiselects.main.write=function(a){wmgui._selectize_write(wmgui.multiselects.main,"main",a)};wmgui.multiselects.main.display=function(a,d){wmgui._selectize_display(wmgui.multiselects.main,a,d)}}
;
