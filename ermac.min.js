...
c[d]=a}));$.each(wmgui.multi_facets,(function(d,e){a=wmgui.multiselects[e].read();a[e]&&(a=a[e],"authors"==e&&(a=a.replace(/'/g,"").replaceAll("\\."," ").replaceAll("\\b\\w{1}\\b","").trim()),c[e]=a);(b=$("#advs_fct_"+e+"-selectized").val())&&(c[e]=c[e]?c[e]+(", "+b):b)}));if($.isEmptyObject(c))return wmgui.notify("Search is empty");var d=$.param(c);window.location.hash=="#inquiry/"+d&&(d="="==d.slice(-1)?d.substr(0,d.length-1):d+"=");window.location.hash="#inquiry/"+d}));$("#advsearch_drop_trigger").click((function(){$("input.advs_input").val("");
$.each(wmgui.multi_facets,(function(a,b){$("#advs_fct_"+b+"-selectized").val("");wmgui.multiselects[b].clear()}));$("#aetmap").hide();$("#aet_limit").prop("checked",!1);destroy_numericbox()}));$("#advsearch_init_trigger").click((function(){$("#advstab_options li").removeClass("working");$("#advstab_options li[rev=advstab_bib]").addClass("working");$("#advstab_bib").show();$("#advstab_main, #advstab_cry").hide();show_advsbox();return!1}));$("#search_box").on("click","#legend a",(function(){var a=$(this).text();
window.location.hash="#search/"+escape(a);return!1}));$("div.advs_legend > a").click((function(){var a=$(this),b=a.text(),c=a.parent().data("multiselects");c?($("#advs_fct_"+c+"-selectized").val(""),wmgui.multiselects[c].clear(),a={},a[c]=b,wmgui.multiselects[c].write(a)):a.parent().parent().children("input").val(b).focus();return!1}));$("#databrowser").on("mousedown","a.resolve_ref",(function(a){a=$(this).attr("rel");$("a.resolve_ref[rel="+a+"]").addClass("visited");wmgui.bid_history.push(parseInt(a));
window.localStorage.setItem("bid_history",JSON.stringify(wmgui.bid_history));return!0}));$("#databrowser").on("click","tr.tcell, div.gallery_item",(function(){open_context($(this),!1)}));$("#databrowser").on("click","span.launch_v",(function(a){wmgui.cancel_event(a);a=$(this).parent().parent();a.removeClass("busy_entry");open_context(a,!0)}));$("#databrowser").on("click","a.launch_ph",(function(a){wmgui.cancel_event(a);a=$(this).attr("href");window.location.hash==a&&(a+=".");window.location.hash=a;return!1}));
$("#all_polyhedra_content").on("click","div.gallery_item",(function(){$("#advstab_options li").removeClass("working");$("#advstab_options li[rev=advstab_cry]").addClass("working");$("div.advstab").hide();$("#advstab_cry").show();$("div.modal").hide();$("#advsbox, #overlay").show();var a=$(this).attr("rel");-1==(wmgui.multiselects.aetypes.read().aetypes||"").split(", ").indexOf(a)&&wmgui.multiselects.aetypes.write({aetypes:a});show_aetmap(a)}));$("#aet_limit").click((function(a){var b=(wmgui.multiselects.classes.read().classes||
"").split(", ");if(this.checked){var c=(wmgui.multiselects.aetypes.read().aetypes||"").split(", ").filter((function(a){return a}));c=wmgui.poly_limits[c.length];if(!c)return wmgui.cancel_event(a),wmgui.notify("Sorry, only up to 3 supported"),!1;-1==b.indexOf(c)&&wmgui.multiselects.classes.write({classes:c})}else{var d=Object.values(wmgui.poly_limits);wmgui.multiselects.classes.clear();wmgui.multiselects.classes.write({classes:b.filter((function(a){return-1==d.indexOf(a)})).join(", ")})}return!0}));$("#visualize").click((function(){close_vibox()||
launch_iframed_app(this.getAttribute("data-rank"))}));$("#refine_col").on("click","a.extd_refine",(function(){var a=$(this).attr("rel");if($("#refine_col > ul > li.extd_rfns.fct_"+a).length)return $("#refine_col > ul > li:not(.fct_"+a+")").addClass("hidden_rfns").slideUp(),$("#refine_col > ul > li.extd_rfns.fct_"+a).show(),$("a.extd_refine[rel="+a+"]").parent().hide(),!1;var b={extd_refine:a};$.extend(b,wmgui.search);try{wmgui.active_ajax.abort()}catch(c){}wmgui.active_ajax=$.ajax({type:"GET",url:wmgui.rfn_endpoint,
data:{q:JSON.stringify(b)}}).done((function(c){if(c.error)return wmgui.notify(c.error);var d="";delete b.numeric;delete b.extd_refine;var f=!1;$.each(wmgui.inquiries,(function(a,c){if(b[c])return f=!0,!1}));$.each(c.payload,(function(c,g){var e="",h={};$.each(b,(function(b,c){if("search_type"==b||"elements"==a&&("elements"==b||"formulae"==b)||"props"==a&&"props"==b)return!0;e+=c+" ";h[b]=h[b]?h[b]+(", "+c):c}));"props"==a&&(g[0]=g[0].replace(/\(|\)/g,"").replace(/\/[\w\-]*/g,""));h[a]=h[a]?h[a]+(", "+g[0]):
g[0];h.elements&&(h.elements=h.elements.replaceAll(", ","-"));d=f?d+('<li class="extd_rfns fct_'+a+'"><a href="#inquiry/'+$.param(h)+'">'+g[0]+"</a></li>"):d+('<li class="extd_rfns fct_'+a+'"><a href="#search/'+e+g[0]+'">'+g[0]+"</a></li>")}));d+='<li class="extd_rfns fct_'+a+' collapse_refine"><a class="collapse_refine" rel="'+a+'" href="#">Show less&nbsp;</a></li>';$("#refine_col > ul > li:not(.fct_"+a+")").addClass("hidden_rfns").slideUp();$("a.extd_refine[rel="+a+"]").parent().hide().after(wmgui.clean(d))})).fail((function(a,
b,f){"abort"!=b&&wmgui.notify("Connection to server is lost, please try to <a href=javascript:location.reload()>reload</a>")}));return!1}));$("#refine_col").on("click","a.collapse_refine",(function(){var a=$(this).attr("rel");$("a.extd_refine[rel="+a+"]").parent().show();$("#refine_col > ul > li.hidden_rfns").removeClass("hidden_rfns").slideDown(250);$("#refine_col > ul > li.extd_rfns").hide();return!1}));$("#fdwidget").on("click","span",(function(){"fdwidget_yes"==$(this).attr("id")?$("#fdwidget").html("We appreciate your feedback!"):
($("#fdwidget").html(wmgui.contact_html),$("#fdwidget_msg").focus())}));$("#fdwidget").on("click","div.wmbutton",(function(){$(this).data("busy")||($(this).data("busy",!0),$.ajax({type:"POST",url:wmgui.fd_endpoint,data:{fdwidget_msg:$("#fdwidget_msg").val(),fdwidget_msgtype:$("#fdwidget_msgtype").val(),fdwidget_url:window.location.href},beforeSend:wmgui.show_preloader}).always(wmgui.hide_preloader).done((function(a){$("#fdwidget_trigger").data("busy",!1);if(a.error)return wmgui.notify(a.error);$("#fdwidget").html("We appreciate your feedback!")})).fail((function(a,
b,c){wmgui.notify("Sorry, cannot process your input")})))}));$("#tagcloudbox").on("click","a.collateral",(function(){$("#userbox").data("saved_hash",!1);var a=$(this).attr("rel");if("adv"==a)$("#advsearch_init_trigger").trigger("click"),$("div.menu_collateral").hide();else if("idea"==a)window.location.hash="#plot/"+WMCORE.get_random_term(["pie","lit","graph"])+"/search/"+WMCORE.get_interesting().text;else if("sod"==a){var b=new Date;a=b.getDate()%wmgui.sbucks.length;var c=new Date(b.getFullYear(),0,
0);b=b-c+6E4*(c.getTimezoneOffset()-b.getTimezoneOffset());window.location.hash="#entry/S"+(wmgui.sbucks[a]+Math.floor(b/864E5))}else"my"==a&&(a=JSON.parse(window.localStorage.getItem("wm")||"{}"),a.name&&(a=a.name.split(" "),window.location.hash="#inquiry/authors="+escape(a[a.length-1])));return!1}));$("#hintsbox_msg").on("click","div.wmbutton",(function(){var a=document.createRange();a.selectNode($("#hintsbox_msg > pre").get(0));window.getSelection().removeAllRanges();window.getSelection().addRange(a);
document.execCommand("copy");wmgui.notify("Copied")}));$("#tooltip").on("click","span",(function(){var a=$(this),b=a.attr("rel");a=a.hasClass("forced");document.getElementById("tooltip").style.display="none";b&&wmgui.tooltips[b]&&show_tooltip(wmgui.tooltips[b],a)}));$("#sim_col").on("click","li > a",(function(){$("#sim_col > ul > li").removeClass("selected");$(this).parent().addClass("selected");wmgui.passive_sim_col=!1;return!0}));$("div.close_user_dialogue").click((function(){$("#userbox").trigger("click")}));
$("div.close_advs_dialogue").click((function(){$("#advsbox, #overlay, #aetmap").hide()}));$("#close_inquiry_dialogue").click((function(){$("#inquirybox").hide()}));$("#close_ss_dialogue").click((function(){var a=$("#ss_x > ul > li.ss_x").attr("rel").split("_")[1],b=$("#ss_y > ul > li.ss_y").attr("rel").split("_")[1],c=$("#sops_x > ul > li.sops_x").text(),d=$("#sops_y > ul > li.sops_y").text();c="none"==c?!1:c;d="none"==d?!1:d;if($("#ss_z").is(":visible")){var f=$("#ss_z > ul > li.ss_z").attr("rel").split("_")[1],
e=$("#sops_z > ul > li.sops_z").text();e="none"==e?!1:e;$("#ctxpanel_cube > ul > li.embodied").removeClass("embodied");$("#viscube_"+a).addClass("embodied");$("#ctxpanel_cube > ul > li.ss_y").removeClass("ss_y");$("#viscube_"+b).addClass("ss_y");$("#ctxpanel_cube > ul > li.ss_z").removeClass("ss_z");$("#viscube_"+f).addClass("ss_z");$("span.sops").remove();c&&$('<span class="sops" rel="x">'+c+"</span>").appendTo("#viscube_"+a);d&&$('<span class="sops" rel="y">'+d+"</span>").appendTo("#viscube_"+b);
e&&$('<span class="sops" rel="z">'+e+"</span>").appendTo("#viscube_"+f);-1!==document.getElementById("visavis_iframe").contentWindow.location.hash.indexOf("fixel=1")?document.getElementById("visavis_iframe").contentWindow.matrix_order(a,b,c,d):document.getElementById("visavis_iframe").contentWindow.cube_order(a,b,f,c,d,e)}else{if(c&&"count"==a||d&&"count"==b)return wmgui.notify("Sorry, data counts are not supported");$("#ctxpanel_matrix > ul > li.embodied").removeClass("embodied");$("#vismatrix_"+
...
if(!a.hasOwnProperty("gui")||!a.hasOwnProperty("api"))return wmgui.notify('Login error: please, <span class="href relogin">re-login</span>');$("#perms_view").html(describe_perms(a))})).fail((function(a,b,f){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))):"usr_tab_ctrl"==b?window.location.href=wmgui.static_host+(0===wmgui.edition?"/ctrl":"/labs/custom-datasets")+"?"+Math.floor(1E3*Math.random()):"usr_tab_account"==b&&$("#hintsbox_msg").html(WMCORE.get_random_term(wmgui.welcome_msgs))}));
...
a.name,a.acclogin,a.admin);window.location.replace("#start");$("#account_pass_change").hide()})).fail((function(a,b,f){"abort"!=b&&wmgui.notify('Login error: please, <span class="href relogin">re-login</span>')}))}}));$("#logout_trigger").click((function(){$.ajax({type:"POST",url:wmgui.logout_endpoint,data:{sid:wmgui.sid}}).done((function(a){})).fail((function(a,b,c){}));user_logout();$("#userbox").trigger("click")}));$("#notifybox").on("click","span.relogin",force_relogin);$("#search_holder").keydown((function(a){13==
...
"33%"),$("#ss_z, #sops_z").show());var b=$("#ctxpanel_"+a+" > ul > li.embodied").attr("id").split("_")[1],c=$("#ctxpanel_"+a+" > ul > li.ss_y"),d=$("#ctxpanel_"+a+" > ul > li.ss_z"),f=c.length?c.attr("id").split("_")[1]:b,e=d.length?d.attr("id").split("_")[1]:b,g="",m="",h="";$("#ctxpanel_"+a+" > ul > li").each((function(){var c=$(this),d=c.attr("id").split("_")[1];c=c.contents().filter((function(){return 1!==this.nodeType}))[0].data.substr(3);var k=d==b?' class="ss_x"':"";g+='<li rev="ss_x" rel="x_'+
d+'"'+k+">"+c+"</li>";k=d==f?' class="ss_y"':"";m+='<li rev="ss_y" rel="y_'+d+'"'+k+">"+c+"</li>";if("matrix"==a)return!0;k=d==e?' class="ss_z"':"";h+='<li rev="ss_z" rel="z_'+d+'"'+k+">"+c+"</li>"}));$("#ss_x > ul").html(g);$("#ss_y > ul").html(m);"cube"==a&&$("#ss_z > ul").html(h);$("li.sops_x").removeClass("sops_x");$("li.sops_y").removeClass("sops_y");$("li.sops_z").removeClass("sops_z");var l=["x","y","z"];$("span.sops").each((function(){var a=$(this),b=a.text(),c=a.attr("rel");$("#sops_"+c+' > ul > li:contains("'+
b+'")').addClass("sops_"+c);l=l.filter((function(a){return a!==c}))}));l.forEach((function(a){$("#sops_"+a+' > ul > li:contains("none")').addClass("sops_"+a)}));$("#ss_custom_box, #overlay").show()}));$("div.ss_col").on("click","li",(function(){var a=$(this),b=a.attr("rev"),c=a.attr("rel").split("_")[0];c="x"==c?"ss_x":"y"==c?"ss_y":"ss_z";$("#"+b+" > ul > li."+c).removeClass(c);a.addClass(c)}));$("div.sops_col").on("click","li",(function(){var a=$(this),b=a.parent().parent().attr("id"),c=b.split("_")[1];
c="x"==c?"sops_x":"y"==c?"sops_y":"sops_z";$("#"+b+" > ul > li."+c).removeClass(c);a.addClass(c)}));$("#tips_trigger").click((function(){wmgui.tooltip_var=0;show_tooltip(wmgui.tooltips.advsearch);return!1}));$("#numericbox").on("click","div.slider_close",(function(){if(1==$("div.slider_numerics").length)return destroy_numericbox(),delete wmgui.search.numeric,$("#search_field-selectized").val(""),wmgui.multiselects.main.clear(),wmgui.multiselects.main.write(wmgui.search),!1;var a=$(this);a.siblings("div.slider").children("div.slider_numerics")[0].noUiSlider.destroy();
...
(a.attr("id")||"").startswith("advs_fct_"))&&$("#advsearch_do_trigger").trigger("click")):27==a&&(a=$("div.cross:visible"),a.length&&a.trigger("click"))}));$(window).bind("hashchange",url_redraw_react);$(window).bind("storage",(function(a){if("wm_reload"==a.originalEvent.key&&(a=a.originalEvent.newValue)&&window[a])window[a]()}))};
var wmgui=window.wmgui||{};
...
a.facet+'">'+a.label+"</div>"},item:function(a,d){return'<div class="fct_'+a.facet+'" data-facet="'+a.facet+'" data-term="'+a.label+'">'+a.label+"</div>"}}})[0].selectize;wmgui.multiselects.main.read=function(){return wmgui._selectize_read("main")};wmgui.multiselects.main.write=function(a){wmgui._selectize_write(wmgui.multiselects.main,"main",a)};wmgui.multiselects.main.display=function(a,d){wmgui._selectize_display(wmgui.multiselects.main,a,d)}};
