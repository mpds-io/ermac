...
wmgui.editions={0:{name:"Materials Platform for Data Science",prod_url:"https://mpds.io",dev_url:"http://localhost:8070",css:wmgui.ermac_root+"/editions/wm/style.css?270521",actions:function(){$("#logo_l").text("MPDS")}},1:{name:"ASM International Materials Platform",prod_url:"https://asm.mpds.io",dev_url:"http://localhost:8075",css:wmgui.ermac_root+"/editions/asm/style.css?270521",actions:function(){$("#subnav > ul > li.subnav_lpf").hide();$("#subnav > ul > li.subnav_asm").css("display","inline-block");
var a=document.querySelector("link[rel*='icon']")||document.createElement("link");a.type="image/x-icon";a.rel="shortcut icon";a.href=wmgui.ermac_root+"/editions/asm/asm.ico";document.getElementsByTagName("head")[0].appendChild(a)}}};
