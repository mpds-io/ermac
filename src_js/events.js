...
function register_events() {
    ...
    $('#advsearch_do_trigger').on('click', function () {
        var curval = '',
            rest_input = '',
            query = {};
    ...
    $('#advsearch_drop_trigger').on('click', function () {
    ...
    $('#advsearch_init_trigger').on('click', function () {
    ...
    $('div.advs_legend > a').on('click', function () {
        var that = $(this),
            legend = that.text(),
    ...
    $('div.close_user_dialogue').on('click', function () {
        $('#userbox').trigger('click');
    });

    $('div.close_advs_dialogue').on('click', function () {
        $('#advsbox, #overlay, #aetmap').hide();
    });

    $('#close_inquiry_dialogue').on('click', function () {
        $('#inquirybox').hide();
    });

    $('#close_ss_dialogue').on('click', function () {
        ...
        if ($('#ss_z').is('[style="display: block"]')) {
    ...
    $('#close_dc_dialogue').on('click', function () {
    ...
    $('#close_formal_dialogue').on('click', function () {
        window.location.hash = '#start';
    });

    // not handled by ermac?
    $('#close_ph_dialogue, div.close_hy_dialogue, div.close_product_dialogue').on('click', function () {
    ...
    /** $('#overlay').on('click',function(){
        $('div.modal[style="display: block"]').each(function(){
            $(this).find('div.cross').trigger('click');
        });
    }); **/

    $('div._close_ctx').on('click', function () {
    ...
    $('strong.numeric').on('click', function () {
        var prop = $(this).attr('rel'),
            data = wmgui.numerics[prop],
            prop_id = data[0],
            units = data[1],
    ...
    $('#hy_options > li').on('click', function () {
        var that = $(this),
    ...
    $('#dtypes > ul > li').on('click', function () {
        var that = $(this),
    ...
    $('span.href[rel]').on('click', function () {
    ...
    $('#tab_links > li').on('click', function () {
        try { wmgui.active_ajax.abort(); } catch (e) { }
        try { wmgui.quick_ajax.abort(); } catch (e) { }
    ...
    $('#advstab_options > li').on('click', function () {
        var that = $(this),
            desttab = that.attr('rev');
    ...
    $('a.link_adjuster').on('click', function () {
        // hash-hack FIXME?
    ...
    $('#create_usr_api_key').on('click', function () {
        $(this).parent().hide();
        try { wmgui.active_ajax.abort(); } catch (e) { }
    ...
    $('#revoke_usr_api_key').on('click', function () {
        $(this).parent().hide();
        try { wmgui.active_ajax.abort(); } catch (e) { }
    ...
    $('#restore_trigger').on('click', function () {
        if ($(this).data('busy')) return;
        $(this).data('busy', true);
        $(this).text('Sending...');
    ...
    $('#account_holder_accpass > span').on('click', function () {
        $('#account_pass_change').toggle();
    });

    $('#password_trigger').on('click', function () {
    ...
    $('#logout_trigger').on('click', function () {
    ...
    $('#control_a').on('click', function () { // entries
        re_view_request(0);
    });
    $('#control_b').on('click', function () { // phases
        re_view_request(1);
    });
    $('#control_f').on('click', function () { // articles
        re_view_request(2);
    });

    // switch sliders: second row cde
    $('#control_c').on('click', function () { // table
    ...
    $('#control_d').on('click', function () { // previews
        wmgui.visavis_terminating = true;
    ...
    $('#control_e').on('click', function () { // plotting
        var orepr = {};
        for (var key in wmgui.search) {
            if (['search_type', 'phid', 'numeric'].indexOf(key) > -1) continue;
            orepr[key] = wmgui.search[key];
    ...
    // visavis ctx
    $('#ctxpanel_matrix > ul > li').on('click', function () {
        var that = $(this);
    ...
    $('#ctxpanel_cube > ul > li').on('click', function () {
        var that = $(this);
    ...
    $('#ctxpanel_graph > ul > li').on('click', function () {
        var that = $(this);
    ...
    $('li.discovery_custom').on('click', function () {
    ...
    $('#ss_gear_matrix, #ss_gear_cube').on('click', function () {
    ...
    $('#tips_trigger').on('click', function () {
    ...
    $('#numericbox_do_trigger').on('click', function () {
        ...
        if ($('#advsbox').is('[style="display: block"]'))
            $('#advsearch_do_trigger').trigger('click');
        else
            $('#search_trigger').trigger('click');
    });

    $('#numericbox_drop_trigger').on('click', function () {
    ...
    $('#close_numericbox').on('click', function () {
        destroy_numericbox();
        delete wmgui.search.numeric;
        $('#search_field-selectized').val('');
        wmgui.multiselects['main'].clear();
    ...
    /*$('#mobilebox span').on('click',function(){
        window.location.href = '/m/' + window.location.hash;
    });
    $('#mobilebox a').on('click',function(){
        $('#mobilebox').remove();
        return false;
    });*/
    ...
    $(document).keydown(function (e) {
        ...
        if (key == 13) { // ENTER: input must trigger submit button via two parent divs!
            ...
            var target = $('div.cross[style="display: block"]');
            if (target.length) target.trigger('click');
        }
    });

    $(window).on('hashchange', url_redraw_react);
