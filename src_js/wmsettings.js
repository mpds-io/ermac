...
wmgui.editions = {
    0: {
        'name': 'Materials Platform for Data Science', 'prod_url': 'https://mpds.io', 'dev_url': 'http://localhost:8070', 'css': wmgui.static_host + '/editions/wm/style.css?260821', 'actions': function () {
            wmgui.$('#logo_l').text('MPDS');
            wmgui.$('.only_asm').hide();
            wmgui.$('.only_mpds').style({ display: 'inline-block' });
        }
    },
    1: {
        'name': 'ASM International Materials Platform', 'prod_url': 'https://asm.mpds.io', 'dev_url': 'http://localhost:8075', 'css': wmgui.static_host + '/editions/asm/style.css?260821', 'actions': function () {
            wmgui.$('.only_mpds').hide();
            wmgui.$('.only_asm').style({ display: 'inline-block' });
            // custom favicon
