 ...
 * Modified by Evgeny Blokhin
 * added window.iframe check
 *
...
(function ($) {
    ...
    $.extend({
        tablesorter: new function () {
            ...
            this.defaults = {
                ...
                decimal: '/\.|\,/g',
                onRenderHeader: null,
                selectorHeaders: '#dataheader_entries > thead > tr > th', ///
                selectorHeaderParent: 'dataheader_entries', ///
                debug: false
            };
            ...
            function buildHeaders(table) {
                ...
                var header_index = computeTableHeaderCellIndexes(document.getElementById(table.config.selectorHeaderParent));

                var $tableHeaders = $(table.config.selectorHeaders).each(function (index) { /// $(, table)
            ...
            function checkCellColSpan(table, rows, row) {
                var arr = [],
                    r = document.getElementById(table.config.selectorHeaderParent).tHead.rows,
                    c = r[row].cells;
            ...
            this.construct = function (settings) {
                return this.each(function () {
                    ...
                    if (!this.tBodies) return; //if (!this.tHead || !this.tBodies) return;
                    // declare
                    ...
                    $headers.click(function (e){
                        ...
                        if (!this.sortDisabled && totalRows > 0) {
                            ...
                            setTimeout(function () {
                                ...
                                appendToTable(
                                    $this[0], multisort($this[0], config.sortList, cache)
                                );
                            }, 1);
    ...
    ts.addParser({
        ...
        is: function (s) {
            ...
            return $.tablesorter.formatInt(s.replace("[", "").replace("]", ""));
        }, type: "numeric"
    });
